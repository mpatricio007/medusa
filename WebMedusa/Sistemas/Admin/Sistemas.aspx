<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="Sistemas.aspx.cs" Inherits="Medusa.Sistemas.Admin.Sistemas" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
<%@ Register src="../../Controles/Log.ascx" tagname="Log" tagprefix="uc1" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="id_sistema">código</asp:ListItem>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Sistemas" CellPadding="4" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="id_sistema" HeaderText="código" 
                                SortExpression="id_sistema">
                            ...
                            <asp:TemplateField HeaderText="menus">                               
                                <ItemTemplate>                                  
                                    <asp:DataList ID="DataList1" runat="server" DataSource='<%# Bind("Menus") %>' >
                                        <ItemTemplate>
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        ...
                        <tr>
                            ...
                            <td class="direito">
                                <ctx:cTexto ID="cTextoSigla" runat="server" EnableValidator="True" MaxLength="20" 
                                    Width="200" />
                            </td>
                        </tr>
                        <tr>

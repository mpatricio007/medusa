<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="Contato_fakes.aspx.cs" Inherits="Medusa.Sistemas.Admin.Contato_fakes" %>
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        ...
                        <tr>
                            ...
                            <td class="direito">
                                <ctx:cTexto ID="cTextoEmail" runat="server" EnableValidator="True" MaxLength="50" 
                                    Width="300" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="direito" style="height: 34px">
                                <ctx:cTexto ID="cTextoTipo" runat="server" MaxLength="50" Width="300" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">

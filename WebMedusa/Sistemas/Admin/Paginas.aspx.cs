    ...
    public partial class Paginas : PageCrud<PaginaBLL>
    {
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            {                
                ...
                ddlTipo.DataSource = Enum.GetNames(typeof(TipoPagina));
                ddlTipo.DataBind();
            }
        }       
        ...
        {  
            ...
            this.ddlTipo.SelectedValue = Enum.GetName(typeof(TipoPagina), ObjBLL.ObjEF.tipo);

            //Log1.Id_entidade = Convert.ToInt32(PkValue);
            //Log1.TEntidade = ObjBLL.ObjEF.GetType();
            //Log1.DataBind();
        }
        ...
        protected override void Set()
        {
            ...
            ObjBLL.ObjEF.tipo = (TipoPagina)Enum.Parse(typeof(TipoPagina), this.ddlTipo.SelectedValue);
        }
    }
}

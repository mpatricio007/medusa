<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="Paginas.aspx.cs" Inherits="Medusa.Sistemas.Admin.Paginas" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="id_pagina">código</asp:ListItem>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Páginas do Medusa" CellPadding="4" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="id_pagina" HeaderText="código" 
                                SortExpression="id_pagina">
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        ...
                        <tr>
                            ...
                            <td class="direito">
                                <ctx:cTexto ID="cTextoUrl" runat="server" Width="500" MaxLength="100" />
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">

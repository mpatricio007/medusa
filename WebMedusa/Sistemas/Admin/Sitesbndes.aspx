<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="Sitesbndes.aspx.cs" Inherits="Medusa.Sistemas.Admin.Sitesbndes" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="atividade">atividade</asp:ListItem>
                        <asp:ListItem>coordenador</asp:ListItem>
                        <asp:ListItem>copatrocinador</asp:ListItem>
                    </asp:DropDownList>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de links da página inicial do site" CellPadding="4" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="coordenador" HeaderText="coordenador" SortExpression="coordenador">
                            </asp:BoundField>
                            <asp:BoundField DataField="copatrocinador" HeaderText="copatrocinador" SortExpression="copatrocinador" />
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        <tr>
                            <th colspan="1">
                                cadastro de links da página inicial</th>
                            <th colspan="1">
                        ...
                        <tr>
                            ...
                            <td class="direito">
                                <ctx:cTexto ID="cTextoAtividade" runat="server" EnableValidator="False" 
                                    Width="500px" TextMode="MultiLine" MaxLength="500" />
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">coordenador:</td>
                            <td class="direito">
                                <ctx:cTexto ID="cTextoCoordenador" runat="server" EnableValidator="False" MaxLength="500" TextMode="MultiLine" Width="500px" />
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">copatrocinador:</td>
                            <td class="direito">
                                <ctx:cTexto ID="cTextoCopatrocinador" runat="server" EnableValidator="False" MaxLength="500" TextMode="MultiLine" Width="500px" />
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">ordem:</td>
                            <td class="direito">
                                <cint:cInteiro ID="cInteiroOrdem" runat="server" EnableValidator="True" />
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">ativo:</td>
                            <td class="direito">

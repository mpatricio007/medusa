...
{
    public partial class Contato_fakes : PageCrud<Contato_fakeBLL>
    {
        ...
        protected override void Get()
        {
            ...
            this.cTextoEmail.Text = ObjBLL.ObjEF.email;
            this.cTextoTipo.Text = ObjBLL.ObjEF.tipo;
        }
        ...
        protected override void Set()
        {
            ...
            ObjBLL.ObjEF.email = this.cTextoEmail.Text;
            ObjBLL.ObjEF.tipo = this.cTextoTipo.Text;

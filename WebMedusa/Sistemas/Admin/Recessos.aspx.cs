...
{
    public partial class Recessos : PageCrud<RecessoBLL>
    {
        protected override void Page_Load(object sender, EventArgs e)
        {
            // chave primária da tabela
            PRIMARY_KEY = "id_recesso";
        ...
        {
            ObjBLL.Get(PkValue);
            this.txtCodigo.Text = Convert.ToString(ObjBLL.ObjEF.id_recesso);
            this.cTextoDescricao.Text = ObjBLL.ObjEF.descricao;
            this.cData.Value = ObjBLL.ObjEF.data;
            this.rbTipo.SelectedValue = ObjBLL.ObjEF.tipo;
        }

        protected override void Set()
        {
            ObjBLL.ObjEF.id_recesso = Convert.ToInt32(this.txtCodigo.Text);

<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="Site_pag_iniciais.aspx.cs" Inherits="Medusa.Sistemas.Admin.Site_pag_iniciais" %>
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="título" SortExpression="titulo">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("HtmlLink") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="Label1" runat="server" Text='<%# Bind("HtmlLink") %>'></asp:Label>
                                </ItemTemplate>
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        ...
                        <tr>
                            ...
                            <td class="direito">
                                <ctx:cTexto ID="cTextoDescricao" runat="server" EnableValidator="False" 
                                    Width="500" TextMode="MultiLine" />
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="esquerdo">link:</td>
                            <td class="direito">
                                <ctx:cTexto ID="cTextoLink" runat="server" EnableValidator="True" />
                            </td>
                        </tr>
                        <tr>

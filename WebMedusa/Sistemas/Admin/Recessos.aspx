<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="Recessos.aspx.cs" Inherits="Medusa.Sistemas.Admin.Recessos" %>
               ...
               <div class="FilterName">
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Recessos" 
                        CssClass="tableView" 
                        ...
                        <tr>
                            ...
                            <td class="direito" style="height: 34px">
                                <ctx:cTexto ID="cTextoDescricao" runat="server" EnableValidator="True" 
                                    MaxLength="100" Width="500" Height="75" TextMode="MultiLine" />
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">
                            ...
                            <td class="direito">
                                <asp:RadioButtonList ID="rbTipo" runat="server" RepeatDirection="Horizontal">
                                    ...
                                    <asp:ListItem>emenda</asp:ListItem>
                                </asp:RadioButtonList>
                            </td>
                        </tr>
                        <tr>

               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="MenuPaginas.Pagina.nome)">MenuPaginas</asp:ListItem>
                    </asp:DropDownList>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Menus" CellPadding="4" 
                        ...
                        <tr>
                            <th colspan="2">
                                <asp:Button ID="btInserePag" runat="server" 
                                    Text="nova página" onclick="btInserePag_Click" 
                                    ValidationGroup="vg_pagmenu" />

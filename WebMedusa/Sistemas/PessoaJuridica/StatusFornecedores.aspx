<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="StatusFornecedores.aspx.cs" Inherits="Medusa.Sistemas.PessoaJuridica.StatusFornecedores" %>
               ...
               <div class="FilterName">
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Status Fornecedores" 
                        CssClass="tableView" 
                        ...
                        <Columns>
                            ...
                            <asp:CheckBoxField DataField="edicao" HeaderText="edição" 
                                SortExpression="edicao" />
                            <asp:CheckBoxField DataField="enviar" HeaderText="enviar" 
                                SortExpression="enviar" />
                            <asp:CheckBoxField DataField="gerar_validade" HeaderText="gerar validade" />
                            <asp:CheckBoxField DataField="gerenciavel" HeaderText="gerenciavel" />
                            <asp:CheckBoxField DataField="emitir_crc" HeaderText="emiti crc" />
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        <tr>
                            <th colspan="1">
                                cadastro de status do fornecedor</th>
                            <th colspan="1">
                        ...
                        <tr>
                            <td class="esquerdo">
                                ordem:</td>
                            <td class="direito">
                                <cint:cInteiro ID="cIntOrdem" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">
                                edição:</td>
                            <td class="direito">
                                <asp:CheckBox ID="cbEdicao" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">
                                enviar</td>
                            <td class="direito">
                                <asp:CheckBox ID="cbEnviar" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">
                                gerar validade:&nbsp;</td>
                            <td class="direito">
                                <asp:CheckBox ID="ckValidade" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">
                                gerenciavel</td>
                            <td class="direito">
                                <asp:CheckBox ID="cbGerenciavel" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">

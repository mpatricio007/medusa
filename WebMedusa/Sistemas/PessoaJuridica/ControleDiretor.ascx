<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ControleDiretor.ascx.cs" Inherits="Medusa.Sistemas.PessoaJuridica.ControleDiretor" %>
                <%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
                            ...
                            AutoGenerateColumns="False" CssClass="tableView" Width="100%" 
                                onrowediting="grid_RowEditing" Caption="lista de diretores">
                                <Columns>
               ...
               <table class="cadastro">
                    ...
                    <tr>
                      ...
                      <tr>
                        ...
                        <td class="direito">
                            <ctx:cTexto ID="cTextoNome" runat="server" Width="350" 
                                ValidationGroup="diretor" MaxLength="100" />
                          </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td class="direito">
                            <cCpf:cCPF ID="cCPF" runat="server" ValidationGroup="diretor" />
                          </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td class="direito">
                            <ctx:cTexto ID="cTextoRg" runat="server" MaxLength="15" Width="162" 
                                ValidationGroup="diretor" />
                          </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td class="direito">
                            <cem:cEmail ID="cEmail" runat="server" ValidationGroup="diretor" />
                          </td>
                      </tr>
                        ...
                        <tr>
                          ...
                          <th colspan="2">
                              <asp:Button ID="btInserir" runat="server" onclick="btInserir_Click" 
                                  Text="inserir" ValidationGroup="diretor" />
                              <asp:Button ID="btAlterar" runat="server" onclick="btAlterar_Click" 
                                  Text="salvar" ValidationGroup="diretor" />

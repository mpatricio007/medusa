<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="RamoAtividades.aspx.cs" Inherits="Medusa.Sistemas.PessoaJuridica.RamoAtividades" %>
               ...
               <div class="FilterName">
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Ramos de Atividades" 
                        CssClass="tableView" 
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        <tr>
                            <th colspan="1">
                                cadastro de ramos de atividades</th>
                            <th colspan="1">
                        ...
                        <tr>
                            <td class="esquerdo">
                                código:</td>
                            <td class="direito">
                                <ctx:cTexto ID="cTextoCodigo" runat="server" Width="60px" />
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">

<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="Categorias.aspx.cs" Inherits="Medusa.Sistemas.PessoaJuridica.Categorias" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
<%@ Register src="../../Controles/DdlCategorias.ascx" tagname="DdlCategorias" tagprefix="uc1" %>
               ...
               <div class="FilterName">
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Categorias" 
                        CssClass="tableView" 
                        ...
                        <Columns>
                            ...
                            <asp:CheckBoxField DataField="emitir_crc" HeaderText="emitir CRC" />
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        ...
                        <tr>
                            <td class="esquerdo" style="height: 28px">
                                status</td>
                        ...
                        <tr>
                            <td class="esquerdo" style="height: 28px">
                                emitir crc:</td>
                            <td class="direito" style="height: 28px">
                                <asp:RadioButtonList ID="rdEmitirCRC" runat="server" 

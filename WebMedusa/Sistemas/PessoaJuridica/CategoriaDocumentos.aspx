<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="CategoriaDocumentos.aspx.cs" Inherits="Medusa.Sistemas.PessoaJuridica.CategoriaDocumentos" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="Documento.nome">documento</asp:ListItem>
                    </asp:DropDownList>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Documentos de Categoria" 
                        CssClass="tableView" 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="documento" SortExpression="Documento.nome">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="Label2" runat="server" Text='<%# Bind("Documento.nome") %>'></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Left" />
                            </asp:TemplateField>
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        <tr>
                            <th colspan="1">
                                cadastro de documentos da categoria</th>
                            <th colspan="1">
                        ...
                        <tr>
                            <td class="esquerdo">
                                categoria:<asp:Label ID="txtCodigo" runat="server" Text="0" Visible="False"></asp:Label>
                            </td>
                            <td class="direito">
                                <DdlCategorias:ddlCategorias ID="ddlCategorias" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">
                            ...
                            <td class="direito">
                                <asp:DropDownList ID="lista" runat="server" AppendDataBoundItems="True" 
                                    DataTextField="nome" DataValueField="id_documento">
                                </asp:DropDownList>

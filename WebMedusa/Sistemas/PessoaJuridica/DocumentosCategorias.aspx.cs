...
{
    public partial class DocumentosCategorias : PageCrud<DocumentosCategoriaBLL>
    {
        ...
        {
            ObjBLL.Get(PkValue);
            this.txtCodigo.Text = Convert.ToString(ObjBLL.ObjEF.id_documento);
        ...
        {
            ObjBLL.ObjEF.id_documento = Convert.ToInt32(this.txtCodigo.Text);

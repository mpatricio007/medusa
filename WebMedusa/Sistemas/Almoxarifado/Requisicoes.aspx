<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="Requisicoes.aspx.cs" Inherits="Medusa.Sistemas.Almoxarifado.Requisicoes" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
<%@ Register src="ControleMaterial.ascx" tagname="ControleMaterial" tagprefix="uc1" %>
               ...
               <div class="FilterName"> 
                ...
                <asp:Panel ID="panelGrid" runat="server" HorizontalAlign="Left">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Requisições de Materiais" 
                        CssClass="tableView" 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="solicitante" 
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox1" runat="server" 
                                        Text='<%# Bind("id_usuario") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="status" SortExpression="StatusRequisicao.nome">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox2" runat="server" 
                                        Text='<%# Bind("StatusRequisicao.nome") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="Label2" runat="server" 
                                        Text='<%# Bind("StatusRequisicao.nome") %>'></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:TemplateField>
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        <tr>
                            ...
                            <div id="dGravacao" runat="server">
                                ...
                                <asp:Button ID="btExcluir" runat="server" CausesValidation="False" 
                                    onclick="btExcluir_Click" Text="excluir" ValidationGroup="requisicao" /><asp:Button ID="btCancelar" runat="server" CausesValidation="False" 
                        ...
                        <tr>
                            ...
                            <td class="direito">
                                <asp:Label ID="cData" runat="server" Text="0"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">
                         ...
                         <tr>
                         <td class="esquerdo">materiais:</td>
                            <td class="direito">
                                <uc1:ControleMaterial ID="ControleMaterial1" runat="server" />
                             </td>
                        </tr>
                         <tr>
                            <td colspan="2">
                         ...
                         <tr>
                            ...
                            <asp:Button ID="btCancelar0" runat="server" CausesValidation="False" 
                                    onclick="btCancelar_Click" Text="cancelar" ValidationGroup="requisicao" />
                                <asp:Button ID="btEnviar" runat="server" onclick="btEnviar_Click" 
                                    Text="enviar requisição" ValidationGroup="requisicao" />
                                </div>
                         </th>
                        </tr>
                    </table>

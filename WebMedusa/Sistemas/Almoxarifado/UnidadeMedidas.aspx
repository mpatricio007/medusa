<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="UnidadeMedidas.aspx.cs" Inherits="Medusa.Sistemas.Almoxarifado.UnidadeMedidas" %>
               ...
               <div class="FilterName"> 
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="id_unidade_medida">código</asp:ListItem>
                        <asp:ListItem Value="descricao">descrição</asp:ListItem>
                        <asp:ListItem Value="num_horas">horas</asp:ListItem>
                    </asp:DropDownList>
                ...
                <asp:Panel ID="panelGrid" runat="server" HorizontalAlign="Left">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Unidade de Medidas" 
                        CssClass="tableView" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="id_unidade_medida" HeaderText="código" 
                                SortExpression="id_unidade_medida">
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        <tr>
                            <th colspan="1">
                                cadastro de unidade de medida</th>
                            <th colspan="1">

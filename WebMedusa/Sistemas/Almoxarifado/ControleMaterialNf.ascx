<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ControleMaterialNf.ascx.cs"
    Inherits="Medusa.Sistemas.Almoxarifado.ControleMaterialNf" %>
    ...
    <tr>
        <td colspan="2" class="style3">
            ...
            <cDdlMaterialConsumo:cDdlMaterialConsumo ID="cDdlMaterialConsumo1" 
                runat="server" ValidationGroup="material" />
&nbsp;quantidade:
            <cint:cInteiro ID="cInteiro1" runat="server" ValidationGroup="material" />
            &nbsp

<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="TipoMateriais.aspx.cs" Inherits="Medusa.Sistemas.Almoxarifado.TipoMateriais" %>
               ...
               <div class="FilterName"> 
                ...
                <asp:Panel ID="panelGrid" runat="server" HorizontalAlign="Left">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de tipo de material" 
                        CssClass="tableView" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="id_tipo_material" HeaderText="código" 
                                SortExpression="id_tipo_material" >
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        <tr>
                            <th colspan="1">
                                cadastro de tipo de material</th>
                            <th colspan="1">

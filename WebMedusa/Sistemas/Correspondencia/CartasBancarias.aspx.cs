...
{
    public partial class CartasBancarias : PageCrud<CartaBancariaBLL>
    {
        ...
        protected override void btInserir_Click(object sender, EventArgs e)
        {
            ...
            if (ObjBLL.ObjEF.data.Year == DateTime.Now.Year)
                if (ObjBLL.SaveChanges())
                {
                    ...
                    Util.ShowMessage(String.Format("Carta bancária de número {0} gerado com sucesso!", ObjBLL.ObjEF.num));
                    PkValue = 0;
                    Get();
                }
                else
                ...
                msgError("Não é permitido inserir uma carta bancária com data diferente do ano atual");
        ...
        protected override void btAlterar_Click(object sender, EventArgs e)
        {
            ...
            if (ObjBLL.MesmoUsuario())
                if (ObjBLL.MesmoAno())
                {
                    ...
                    msgError("Não é permitido alterar uma carta bancária com data diferente do ano atual");
            else
                msgError("Somente quem criou a carta bancária pode alterá-la");
        }
        protected override void btExcluir_Click(object sender, EventArgs e)
        {
            ...
            if (ObjBLL.MesmoUsuario())
                if (ObjBLL.MesmoAno())
                {
                    ...
                    msgError("Não é permitido excluir uma carta bancária com data diferente do ano atual");
            else
                msgError("Somente quem criou a carta bancária pode excluí-la");
        }
        ...
        protected override void SetGrid()
        {
            ...
            filtros.Add(f);
            this.grid.Caption = String.Format("Lista de Cartas Bancárias de {0}", f.value);
            base.SetGrid();
            filtros.Remove(f);
        }

...
{
    public partial class CircularesInternas : PageCrud<CircularInternaBLL>
    {
        ...
        protected override void btInserir_Click(object sender, EventArgs e)
        {
            ...
            //if (ObjBLL.ObjEF.data.Year == DateTime.Now.Year)
                if (ObjBLL.SaveChanges())
                {
                    ...
                    Util.ShowMessage(String.Format("Circular interna de número {0} gerado com sucesso!", ObjBLL.ObjEF.num));
                    PkValue = 0;
                    Get();
                }
                else
            ...
            //else
            //    msgError("Não é permitido inserir uma circular interna com data diferente do ano atual");
        ...
        protected override void btAlterar_Click(object sender, EventArgs e)
        {
            ...
            //    }
            //    else
            //        msgError("Não é permitido alterar uma circular interna com data diferente do ano atual");
            //else
            //    msgError("Somente quem criou a circular interna pode alterá-la");
        }
        protected override void btExcluir_Click(object sender, EventArgs e)
        {
            ...
            //    }
            //    else
            //        msgError("Não é permitido excluir uma circular interna com data diferente do ano atual");
            //else
            //    msgError("Somente quem criou a circular interna pode excluí-la");
        }
        ...
        protected override void SetGrid()
        {
            ...
            filtros.Add(f);
            this.grid.Caption = String.Format("Lista de Circulares Internas de {0}", f.value);
            base.SetGrid();
            filtros.Remove(f);
        }

...
{
    public partial class Setores : PageCrud<SetorBLL>
    {
        protected override void Page_Load(object sender, EventArgs e)
        {
            // chave primária da tabela
            PRIMARY_KEY = "id_setor";
        ...
        {  
            ObjBLL.Get(PkValue);
            this.txtCodigo.Text = Convert.ToString(ObjBLL.ObjEF.id_setor);
        ...
        {
            ObjBLL.ObjEF.id_setor = Convert.ToInt32(this.txtCodigo.Text);

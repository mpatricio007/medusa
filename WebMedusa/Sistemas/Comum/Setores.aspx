<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="Setores.aspx.cs" Inherits="Medusa.Sistemas.Comum.Setores" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="id_setor">código</asp:ListItem>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Setores" CellPadding="4" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="id_setor" HeaderText="código" 
                                SortExpression="id_setor">
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        ...
                        <tr>
                            ...
                            <td class="direito">
                                <ctx:cTexto ID="cTextoSigla" runat="server" Width="100" MaxLength="10" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">

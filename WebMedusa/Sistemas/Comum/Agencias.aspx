<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="Agencias.aspx.cs" Inherits="Medusa.Sistemas.Comum.Agencias" %>
               ...
               <div class="FilterName">
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Agências Bancárias" CellPadding="4" 
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        <tr>
                            <th colspan="1">
                                cadastro de agências bancárias</th>
                            <th colspan="1">
                        ...
                        <tr>
                            <td class="esquerdo">
                                número convênio:</td>
                            <td class="direito">
                                <ctx:cTexto ID="cTextoNumConvenio" runat="server" EnableValidator="True" 
                                    MaxLength="14" Width="100" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">

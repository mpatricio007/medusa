<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="Contas.aspx.cs" Inherits="Medusa.Sistemas.Comum.Contas" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="BancoAgencia.numero">nº da agência</asp:ListItem>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Contas" CellPadding="4" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="numero" HeaderText="nº da conta" 
                            ...
                            <asp:TemplateField HeaderText="projeto" SortExpression="Projeto.codigo">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox4" runat="server" Text='<%# Bind("Projeto.codigo") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="Label4" runat="server" Text='<%# Bind("Projeto.codigo") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="agência" SortExpression="BancoAgencia.numero">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox2" runat="server" 
                                        Text='<%# Bind("BancoAgencia.nome") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="Label2" runat="server" Text='<%# Bind("BancoAgencia.numero") %>'></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Left" />
                            </asp:TemplateField>
                            ...
                            <asp:CheckBoxField DataField="status" Text="ativa" />
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        ...
                        <tr>
                                ...
                                <asp:TextBox ID="txtCodigo" runat="server" Width="43px" Enabled="False">0</asp:TextBox>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="direito">
                                                        ...
                                                        <cDdlAgencias:cDdlAgencias ID="cDdlAgencias1" runat="server" />
                            ...
                            <td class="direito">
                                <ctx:cTexto ID="cTextoNumero" runat="server" EnableValidator="True" MaxLength="10" 
                                    Width="80" />
                                <asp:TextBox ID="txtDigito" runat="server" MaxLength="1" Width="20px"></asp:TextBox>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="esquerdo">
                                tipo de conta:</td>
                            <td class="direito">
                                <cDdlTipoConta:cDdlTipoConta ID="cDdlTipoConta1" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">
                        ...
                        <tr>
                            <td class="esquerdo">
                                saldo inicial:</td>
                            <td class="direito">
                                &nbsp;<cvl:cValor ID="cValorSaldo" runat="server" EnableValidator="False" />
                                data:
                                <cdt:cData ID="cDataSaldo" runat="server" EnableValidator="False" />
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">
                        ...
                        <tr>
                            <td class="esquerdo">
                                data de abertura da conta:</td>
                            <td class="direito">
                                <cdt:cData ID="cDataAbertura" runat="server" EnableValidator="False" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">

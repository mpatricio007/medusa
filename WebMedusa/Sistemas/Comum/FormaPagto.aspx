<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="FormaPagto.aspx.cs" Inherits="Medusa.Sistemas.Comum.FormaPagto" %>
               ...
               <div class="FilterName">
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Formas Pagamentos" CellPadding="4" 
                        ...
                        <Columns>
                            ...
                            <asp:CheckBoxField DataField="eh_mesmo_banco" HeaderText="mesmo banco" 
                                SortExpression="eh_mesmo_banco" />
                            <asp:BoundField DataField="valor_min" HeaderText="valor min" 
                                SortExpression="valor_min" />
                            <asp:BoundField DataField="valor_max" HeaderText="valor_max" 
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        <tr>
                            <th colspan="1">
                                cadastro de formas de pagamentos</th>
                            <th colspan="1">
                        ...
                        <tr>
                            <td class="esquerdo">
                                código do banco:</td>
                            <td class="direito">
                                <ctx:cTexto ID="cTextoBanco" runat="server" EnableValidator="True" 
                        ...
                        <tr>
                            <td class="esquerdo">
                                valor mínimo:</td>
                            <td class="direito">
                                <cvl:cValor ID="cValorMin" runat="server" EnableValidator="False" />
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">
                                valor máximo:</td>
                            <td class="direito">
                                <cvl:cValor ID="cValorMax" runat="server" EnableValidator="False"/>
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">
                                mesmo banco:</td>
                            <td class="direito">
                                <asp:CheckBox ID="ckMesmoBanco" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                        ...
                        <tr>
                            <th colspan="2">
                            <div id="dGravacao1" runat="server"></div>

...
{
    public partial class Documentos : PageCrud<DocumentoBLL>
    {
        ...
        {
            ObjBLL.Get(PkValue);
            this.cInteiro1.Text = Convert.ToString(ObjBLL.ObjEF.id_documento);
        ...
        {
            ObjBLL.ObjEF.id_documento = this.cInteiro1.Value.GetValueOrDefault();

<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="PlanoContas.aspx.cs" Inherits="Medusa.Sistemas.SCP.PlanoContas" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="id_plano_conta">código</asp:ListItem>
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        <tr>
                            <th colspan="1">
                                cadastro de planos de contas</th>
                            <th colspan="1">
                        ...
                        <tr>
                            <td class="esquerdo">
                                conta contabil:</td>
                            <td class="direito">
                                <ctx:cTexto ID="cTextoContaContabil" runat="server" Width="300" 
                                    MaxLength="25" />
                            </td>
                        </tr>
                        <tr>

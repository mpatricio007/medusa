<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="TipoSolicitacoes.aspx.cs" Inherits="Medusa.Sistemas.SCP.TipoSolicitacoes" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="id_tipo_solicitacao">código</asp:ListItem>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Tipos de Solicitacoes" CellPadding="4" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="id_tipo_solicitacao" HeaderText="código" 
                                SortExpression="id_tipo_solicitacao" >
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        <tr>
                            <th colspan="1">
                                cadastro de tipo de solicitação</th>
                            <th colspan="1">

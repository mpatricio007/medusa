...
{
    public partial class ControleArquivoAnexo1 : ControlCrud<ArquivoAnexoProjetoBLL>
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            PRIMARY_KEY = "id_arquivo_anexo_proj";
        ...
        {
            ObjBLL.Get(PkValue);
            this.txtCodigo.Text = Convert.ToString(ObjBLL.ObjEF.id_arquivo_anexo_proj);
            this.cTextoNome.Text = ObjBLL.ObjEF.nome_arquivo;
            this.spanUploading.Visible = false;
            lkArquivo.Text = ObjBLL.ObjEF.nome_arquivo;

        }

        protected override void Set()
        {
            ObjBLL.ObjEF.id_arquivo_anexo_proj = Convert.ToInt32(this.txtCodigo.Text);
            ObjBLL.ObjEF.nome_arquivo = this.cTextoNome.Text;
        ...
        protected override void btInserir_Click(object sender, EventArgs e)
        {
            ...
            if (ObjBLL.DataIsValid(ref strMsg))
            {
                ...
                {
                    ObjBLL.Detach();
                    ObjBLL.ObjEF.id_arquivo_anexo_proj = 0;
                    Get();
                    SetAdd();
                    SetGrid();
                }

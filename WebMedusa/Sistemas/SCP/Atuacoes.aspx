<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="Atuacoes.aspx.cs" Inherits="Medusa.Sistemas.SCP.Atuacoes" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="id_atuacao">código</asp:ListItem>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Atuações" CellPadding="4" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="id_atuacao" HeaderText="código" 
                                SortExpression="id_atuacao">

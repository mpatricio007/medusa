<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="StatusSolicitacoes.aspx.cs" Inherits="Medusa.Sistemas.SCP.StatusSolicitacoes" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="id_status_solicitacao">código</asp:ListItem>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Status de Solicitações" CellPadding="4" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="id_status_solicitacao" HeaderText="código" 
                                SortExpression="id_status_solicitacao" >
                    ...
                    <table class="cadastro">
                        <tr>
                            <th colspan="1" class="style1">
                                cadastro de status de solicitações</th>
                            <th colspan="1" class="style1">

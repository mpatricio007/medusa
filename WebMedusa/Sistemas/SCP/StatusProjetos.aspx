<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="StatusProjetos.aspx.cs" Inherits="Medusa.Sistemas.SCP.StatusProjetos" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="id_status_projeto">código</asp:ListItem>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Status de Projetos" CellPadding="4" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="id_status_projeto" HeaderText="código" 
                                SortExpression="id_status_projeto">
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        <tr>
                            <th colspan="1">
                                cadastro de status de projeto</th>
                            <th colspan="1">

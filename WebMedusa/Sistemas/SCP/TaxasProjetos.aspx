<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="TaxasProjetos.aspx.cs" Inherits="Medusa.Sistemas.SCP.TaxasProjetos" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="id_taxa" Selected="True">código</asp:ListItem>
                        <asp:ListItem Value="nome">nome</asp:ListItem>
                        <asp:ListItem>taxa</asp:ListItem>
                    </asp:DropDownList>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Taxas de Projeto" CellPadding="4" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="id_taxa" HeaderText="código" 
                                SortExpression="id_taxa">
                            ...
                            <asp:TemplateField HeaderText="taxa" SortExpression="taxa">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="Label1" runat="server" Text='<%# Bind("taxa", "{0:n}%") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:BoundField DataField="deb_ctb" HeaderText="débito contab." 
                                SortExpression="deb_ctb" />
                            <asp:BoundField DataField="cred_ctb" HeaderText="crédito contab." 
                                SortExpression="cred_ctb" />
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        <tr>
                            <th colspan="1">
                                cadastro de taxas de projetos</th>
                            <th colspan="1">
                        ...
                        <tr>
                            <td class="esquerdo">
                                nome:
                                <asp:Label ID="cInteiro1" runat="server" Text="0" Visible="False"></asp:Label>
                                </td>
                            <td class="direito">
                                <ctx:cTexto ID="cTextoNome" runat="server" EnableValidator="True" Width="300px" 
                                    MaxLength="50" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="direito">
                                <cvl:cValor ID="cValorTaxa" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">
                        ...
                        <tr>
                            <td class="esquerdo">
                                débito contabilidade:</td>
                            <td class="direito">
                                <ctx:cTexto ID="cTextoDebCtb" runat="server" Width="300px" />
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">
                                crédito contabilidade:</td>
                            <td class="direito">
                                <ctx:cTexto ID="cTextoCredCtb" runat="server" Width="300px" />
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">

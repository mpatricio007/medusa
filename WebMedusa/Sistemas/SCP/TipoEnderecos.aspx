<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="TipoEnderecos.aspx.cs" Inherits="Medusa.Sistemas.SCP.TipoEnderecos" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="id_tipo_ender">código</asp:ListItem>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de TipoEnderecos" CellPadding="4" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="id_tipo_ender" HeaderText="código" 
                                SortExpression="id_tipo_ender" >

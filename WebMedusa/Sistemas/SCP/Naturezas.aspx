<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="Naturezas.aspx.cs" Inherits="Medusa.Sistemas.SCP.Naturezas" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="id_natureza">código</asp:ListItem>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Naturezas do Patrocinador" CellPadding="4" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="id_natureza" HeaderText="código" 
                                SortExpression="id_natureza">

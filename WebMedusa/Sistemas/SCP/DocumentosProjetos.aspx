<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="DocumentosProjetos.aspx.cs" Inherits="Medusa.Sistemas.SCP.DocumentosProjetos" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="id_documento">código</asp:ListItem>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Documentos" CellPadding="4" 
                    ...
                    <table class="cadastro">
                        <tr>
                            ...
                            <div id="dGravacao" runat="server">
                              ...
                              <tr>
                            <td class="esquerdo">
                                sigla:<asp:Label ID="txtCodigo" runat="server" Text="0" Visible="False"></asp:Label>
                                  </td>
                            <td class="direito">
                                <ctx:cTexto ID="cTextoSigla" runat="server" EnableValidator="False" 

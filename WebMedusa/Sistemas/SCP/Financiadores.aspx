<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.master" AutoEventWireup="true" CodeBehind="Financiadores.aspx.cs" Inherits="Medusa.Sistemas.SCP.Financiadores" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="id_financiador">código</asp:ListItem>
                        <asp:ListItem Value="nome">nome</asp:ListItem>
                        <asp:ListItem Value="cnpj.Value">cnpj</asp:ListItem>
                        <asp:ListItem Value="Natureza.nome">natureza</asp:ListItem>
                    </asp:DropDownList>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Financiadores" CellPadding="4" 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="cnpj" SortExpression="cnpj.Value">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="Label2" runat="server" Text='<%# Bind("cnpj") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="natureza" SortExpression="natureza.nome">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("natureza.nome") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="Label1" runat="server" Text='<%# Bind("natureza.nome") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        ...
                        <tr>
                            <td class="esquerdo">
                                cnpj:
                                <asp:TextBox ID="txtCodigo" runat="server" Enabled="False" Width="43px" 
                                    Visible="False">0</asp:TextBox>
                                </td>
                            <td class="direito">
                                <cCnpj:cCNPJ ID="cCNPJ1" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">
                        ...
                        <tr>
                            <td class="esquerdo">
                                natureza:</td>
                            <td class="direito">
                                <cddlNatureza:cDdlNatureza ID="cDdlNatureza1" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cDdlNatureza1_SelectedIndexChanged"  />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                        ...
                        <tr>
                            ...
                            <td class="direito">
                                <cListaemails:cListaEmails ID="cListaEmails1" runat="server" />
                            </td>
                        ...
                        <tr>
                            <td class="esquerdo">
                                telefones:</td>
                            <td class="direito">
                                <cListatelefones:cListaTelefones ID="cListaTelefones1" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">

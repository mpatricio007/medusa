<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.master" AutoEventWireup="true" CodeBehind="Coordenadores.aspx.cs" Inherits="Medusa.Sistemas.SCP.Coordenadores" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="Unidade.nome">unidade</asp:ListItem>
                        <asp:ListItem Value="Departamento.nome">departamento</asp:ListItem>
                        <asp:ListItem Value="Laboratorio.nome">laboratorio</asp:ListItem>
                    </asp:DropDownList>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Coordenadores" CellPadding="4" 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="unidade" SortExpression="Unidade.nome">
                                <EditItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="departamento" SortExpression="Departamento.nome">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="Label2" runat="server" Text='<%# Bind("Departamento.nome") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="laboratorio" SortExpression="Laboratorio.nome">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox3" runat="server" 
                                        Text='<%# Bind("Laboratorio.nome") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="Label3" runat="server" Text='<%# Bind("Laboratorio.nome") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        ...
                        <tr>
                            ...
                            <td class="direito">
                                <cdt:cData ID="cDataNascto" runat="server" ValidationGroup="coordenador" />
                            </td>
                        </tr>
    ...
    ValueToCompare="0" ControlToValidate="listaUnidade"></asp:CompareValidator></tr>
                            ...
                            <td class="direito">
                                <asp:DropDownList ID="listaDepto" runat="server" AppendDataBoundItems="True" 
                                  ...
                                  Width="500px" AutoPostBack="True" 
                                    onselectedindexchanged="listaDepto_SelectedIndexChanged">
                                </asp:DropDownList>
                        ...
                        <tr>
                            <td class="esquerdo">
                                laboratorio:</td>
                            <td class="direito">
                                <asp:DropDownList ID="listaLab" runat="server" AppendDataBoundItems="True" 
    DataTextField="nome" DataValueField="id_laboratorio" Width="500px">
</asp:DropDownList>
<ajaxToolkit:ListSearchExtender ID="listaLab_ListSearchExtender" runat="server" 
    Enabled="True" PromptCssClass="ListSearchExtenderPrompt" 
    PromptText="digite para procurar" QueryPattern="Contains" QueryTimeout="2000" 
    TargetControlID="listaLab">

<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="ClassificacoesFusp.aspx.cs" Inherits="Medusa.Sistemas.SCP.ClassificaçõesFusp" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="id_classificacao_fusp">código</asp:ListItem>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de ClassificaçõesFusp" CellPadding="4" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="id_classificacao_fusp" HeaderText="código" 
                                SortExpression="id_classificacao_fusp" >

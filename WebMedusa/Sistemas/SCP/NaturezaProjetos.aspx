<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="NaturezaProjetos.aspx.cs" Inherits="Medusa.Sistemas.SCP.NaturezaProjetos" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="id_nat_projeto">código</asp:ListItem>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Naturezas de Projeto" CellPadding="4" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="id_nat_projeto" HeaderText="código" 
                                SortExpression="id_nat_projeto">
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        <tr>
                            <th colspan="1">
                                cadastro da natureza do projeto</th>
                            <th colspan="1">

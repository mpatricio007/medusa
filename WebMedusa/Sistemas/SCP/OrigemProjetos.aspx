<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="OrigemProjetos.aspx.cs" Inherits="Medusa.Sistemas.SCP.OrigemProjetos" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="id_origem">código</asp:ListItem>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Origem de Projetos" CellPadding="4" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="id_origem" HeaderText="código" 
                                SortExpression="id_origem">

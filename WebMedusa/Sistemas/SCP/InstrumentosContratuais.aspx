<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="InstrumentosContratuais.aspx.cs" Inherits="Medusa.Sistemas.SCP.InstrumentosContratuais" %>
    ...
    <div class="conteudo">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                        ...
                        oncheckedchanged="ckFilter_CheckedChanged"  CausesValidation="false"
               ...
               <div class="FilterName">
                ...
                <%# Eval("value")%> &nbsp 
                   <asp:ImageButton ID="btExcluiFiltro" runat="server" 
                       ImageUrl="~/Styles/img/bt_delete.jpg" Width="15px" Height="15px" CommandName="delete" CausesValidation="false"
                        />
                </div>
            </ItemTemplate>
        </asp:DataList>
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="false"
                        AutoPostBack="True" onselectedindexchanged="ddlOptions_SelectedIndexChanged">
                        <asp:ListItem Value="id_instrumento_contratual" Selected="True">código</asp:ListItem>
                    ...
                    &nbsp;
                    <asp:DropDownList ID="ddlSize" runat="server" AutoPostBack="True" CausesValidation="false" 
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Instrumentos Contratuais" CellPadding="4" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="id_instrumento_contratual" HeaderText="código" 
                                SortExpression="id_instrumento_contratual">
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        <tr>
                            <th colspan="1">
                                cadastro de instrumentos contratuais</th>
                            <th colspan="1">
                            <div id="dGravacao" runat="server">
                                <asp:Button ID="btInserir" runat="server" onclick="btInserir_Click" ValidationGroup="instrumento"
                                    Text="inserir" />
                                <asp:Button ID="btAlterar" runat="server" onclick="btAlterar_Click" ValidationGroup="instrumento"
                                    Text="salvar" />
                        ...
                        <tr>
                            ...
                            <td class="direito">
                                <ctx:cTexto ID="cTextoNome" runat="server" Width="400px" ValidationGroup="instrumento"
                                    MaxLength="50" />
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <div id="dGravacao1" runat="server">
                                <asp:Button ID="btInserir0" runat="server" onclick="btInserir_Click" ValidationGroup="instrumento"
                                     Text="inserir" />
                                <asp:Button ID="btAlterar0" runat="server" onclick="btAlterar_Click" ValidationGroup="instrumento"
                                    Text="salvar" />

<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="Unidades.aspx.cs" Inherits="Medusa.Sistemas.SCP.Unidades" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
<%@ Register src="../../Controles/Endereco.ascx" tagname="Endereco" tagprefix="uc1" %>
<%@ Register src="../../Controles/Ceps.ascx" tagname="ceps" tagprefix="uc2" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="id_unidade">codigo</asp:ListItem>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Unidades" CellPadding="4" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="id_unidade" HeaderText="código" 
                    ...
                    <table class="cadastro">
                        <tr>
                            ...
                            <div id="dGravacao" runat="server">
                                ...
                                <asp:Button ID="btExcluir" runat="server" CausesValidation="False" 
                                    ...
                                    onclick="btCancelar_Click" Text="cancelar" Width="73px" />
                                    </div>
                            </th>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="esquerdo">
                                sigla:</td>
                            <td class="direito">
                                <ctx:cTexto ID="cTextoSigla" runat="server" EnableValidator="True" 
                        ...
                        <tr>
                            <td class="esquerdo">
                                nome:</td>
                            <td class="direito">
                                <ctx:cTexto ID="cTextoNome" runat="server" EnableValidator="True" MaxLength="150" 
                                    Width="500px" />

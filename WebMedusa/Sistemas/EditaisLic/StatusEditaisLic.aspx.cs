...
{
    public partial class StatusEditaisLic : PageCrud<StatusEditaisLicBLL>
    {
        protected override void Page_Load(object sender, EventArgs e)
        {
            // chave primária da tabela
            PRIMARY_KEY = "id_status_edital_lic";
        ...
        {
            ObjBLL.Get(PkValue);
            this.txtCodigo.Text = Convert.ToString(ObjBLL.ObjEF.id_status_edital_lic);
        ...
        {
            ObjBLL.ObjEF.id_status_edital_lic = Convert.ToInt32(this.txtCodigo.Text);

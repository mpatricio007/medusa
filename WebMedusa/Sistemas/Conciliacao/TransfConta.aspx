<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="TransfConta.aspx.cs" Inherits="Medusa.Sistemas.Conciliacao.TransfConta" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
<%@ Register src="../../Controles/DdlContas.ascx" tagname="DdlContas" tagprefix="uc1" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="id_transf">código</asp:ListItem>
                        <asp:ListItem Value="descricao">descrição</asp:ListItem>
                        <asp:ListItem Value="data">data</asp:ListItem>
                        <asp:ListItem Value="DebitoConta.numero">conta débito</asp:ListItem>
                        <asp:ListItem Value="CreditoConta.numero">conta crédito</asp:ListItem>
                    </asp:DropDownList>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Transferência entre Contas" CellPadding="4" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="id_transf" HeaderText="código" 
                                SortExpression="id_transf">
                            ...
                            <asp:TemplateField HeaderText="conta crédito" 
                                SortExpression="CreditoConta.numero">
                              
                                <ItemTemplate>
                                    <asp:Label ID="Label1" runat="server" 
                                        Text='<%# Bind("CreditoConta.numero") %>'></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Left" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="conta débito" 
                                SortExpression="DebitoConta.numero">
                               
                                <ItemTemplate>
                                    <asp:Label ID="Label2" runat="server" 
                                        Text='<%# Bind("DebitoConta.numero") %>'></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:TemplateField>
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        ...
                        <tr>
                            ...
                            <td class="direito">
                                <uc1:DdlContas ID="DdlContasCredito" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">
                                conta débito:
                                <asp:CustomValidator ID="cvContas" runat="server" 
                                    ErrorMessage="selecione contas diferentes" ForeColor="Red" 
                                    onservervalidate="cvContas_ServerValidate"></asp:CustomValidator>
                            </td>
                            <td class="direito">
                                <uc1:DdlContas ID="DdlContasDebito" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">

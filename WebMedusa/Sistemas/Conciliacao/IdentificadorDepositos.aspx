<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.master" AutoEventWireup="true" CodeBehind="IdentificadorDepositos.aspx.cs" Inherits="Medusa.Sistemas.Conciliacao.IdentificadorDepositos" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="id_identificador">código</asp:ListItem>
                        <asp:ListItem Value="num_identificador">nº identicador</asp:ListItem>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Identificadores de Depósito" CellPadding="4" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="id_identificador" HeaderText="código" 
                                SortExpression="id_identificador">
                            <HeaderStyle Width="100px" HorizontalAlign="Left" />
                            <ItemStyle Width="100px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="num_identificador" HeaderText="nº identicador" 
                                SortExpression="num_identificador">
                            ...
                            <asp:TemplateField HeaderText="conta" SortExpression="conta.HtmlPaginaConta">
                                <ItemTemplate>
                                    <asp:Label ID="Label1" runat="server" 
                                        Text='<%# Bind("conta.HtmlPaginaConta") %>'></asp:Label>
                                </ItemTemplate>
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        <tr>
                            <th colspan="1">
                                cadastro de identificadores de depósito</th>
                            <th colspan="1">
                        ...
                        <tr>
                            ...
                            <td class="direito">
                                <ctx:cTexto ID="cTextoNum" runat="server" MaxLength="15" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="direito" style="height: 25px">
                                <uc1:DdlContas ID="DdlContas1" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">

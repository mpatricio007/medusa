<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="TiposConta.aspx.cs" Inherits="Medusa.Sistemas.Conciliacao.TiposConta" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="id_tipoconta">código</asp:ListItem>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Cadastro de Tipos de Conta" CellPadding="4" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="id_tipoconta" HeaderText="código" 
                                SortExpression="id_tipoconta">
                            ...
                            <asp:CheckBoxField DataField="conta_especifico" HeaderText="conta especifico" />
                    ...
                    <table class="cadastro">
                        ...
                        <tr>
                            <td class="esquerdo">
                                conta especifico:</td>
                            <td class="direito">
                                <asp:CheckBox ID="ckContaEspecifico" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">

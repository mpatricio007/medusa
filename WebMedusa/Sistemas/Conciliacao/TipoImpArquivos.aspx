<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="TipoImpArquivos.aspx.cs" Inherits="Medusa.Sistemas.Conciliacao.TipoImpArquivos" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="id_tipoimp">código</asp:ListItem>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        ...
                        Caption="Lista de Tipos de Importação de Arquivos" CellPadding="4" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="id_tipoimp" HeaderText="código" 
                                SortExpression="id_tipoimp">
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        <tr>
                            <th colspan="1">
                                cadastro de tipos imp. de arquivos</th>
                            <th colspan="1">

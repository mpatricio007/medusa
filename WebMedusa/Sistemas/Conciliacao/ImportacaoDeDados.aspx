<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="ImportacaoDeDados.aspx.cs" Inherits="Medusa.Sistemas.Conciliacao.ImportacaoDeDados" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="id_imparq">código</asp:ListItem>
                        <asp:ListItem Value="data">data</asp:ListItem>
                        <asp:ListItem Value="data_importacao">data processamento</asp:ListItem>
                        <asp:ListItem Value="Usuario.nome">responsável</asp:ListItem>
                        <asp:ListItem Value="TipoArquivo.descricao">tipo</asp:ListItem>
                    </asp:DropDownList>
                    ...
                    <asp:Button ID="btCriar" runat="server" CausesValidation="False" 
                        onclick="btCriar_Click"  Text="novo" Width="80px" Visible="False" />
                </div>
                <asp:Panel ID="panelGrid" runat="server">
                          
                            
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Importações de Dados" CellPadding="4" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="id_imparq" HeaderText="código" 
                                SortExpression="id_imparq">
                            ...
                            <asp:TemplateField HeaderText="tipo">
                                <ItemTemplate>
                                    <asp:Label ID="Label2" runat="server" 
                                        Text='<%# Bind("TipoArquivo.descricao") %>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox2" runat="server" 
                                        Text='<%# Bind("TipoArquivo.descricao") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <HeaderStyle HorizontalAlign="Left" />
                            </asp:TemplateField>
                            ...
                            <asp:BoundField DataField="data_importacao" HeaderText="data processamento" 
                                SortExpression="data_importacao" DataFormatString="{0:dd/MM/yyyy}">
                            <HeaderStyle HorizontalAlign="Left" />
                            </asp:BoundField>
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        ...
                        <tr>
                            ...
                            <td class="direito">
                                <cDdlTipoImportacao:cDdlTipoImportacao ID="cDdlTipoImportacao1" 
                                    runat="server" Enabled="False" />
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">
                                data de importação:</td>
                            <td class="direito">
                                <cdt:cData ID="cData1" runat="server" Enabled="False" />
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">

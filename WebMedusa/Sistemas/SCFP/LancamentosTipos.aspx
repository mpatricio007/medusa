<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="LancamentosTipos.aspx.cs" Inherits="Medusa.Sistemas.SCFP.LancamentosTipos" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="id_lancto_tipo">código</asp:ListItem>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de LancamentosTipos" CellPadding="4" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="id_lancto_tipo" HeaderText="código" SortExpression="id_lancto_tipo" >
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        <tr>
                            <th colspan="1">
                                cadastro de lançamento tipo</th>
                            <th colspan="1">
                        ...
                        <tr id="trPlanoContas" runat="server">
                            <td class="esquerdo">planos de conta:</td>
                            <td class="direito">
                                <table>
                                    <tr>
                                        <td colspan="2" align="left">
                                            <asp:GridView ID="gridPlanosContas" runat="server" AutoGenerateColumns="False"
                                                DataKeyNames="id_lanTipo_Pc"
                                                ...
                                                AllowSorting="True" OnRowDeleting="gridPlanosContas_RowDeleting">
                                                <PagerStyle CssClass="pgr" />
                                                <RowStyle BackColor="#dedede" ForeColor="Black" />
                                                <AlternatingRowStyle BackColor="White" ForeColor="Black" />
                                                <Columns>
                                                    <asp:TemplateField HeaderText="plano de conta">
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("plconta.strPlanoContas") %>'></asp:TextBox>
                                                        </EditItemTemplate>
                                                        <ItemTemplate>
                                                            <asp:Label ID="Label1" runat="server" Text='<%# Bind("plconta.strPlanoContas") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                    ...
                                    <tr>
                                        <td>
                                            <cDdlPlanoConta:cDdlPlanoConta ID="cDdlPlanoConta1" runat="server" ValidationGroup="plano_conta" />
                                        </td>
                                        <td align="left">

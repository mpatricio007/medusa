<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="DespesasServTercPJ.aspx.cs" Inherits="Medusa.Sistemas.SCFP.DespesasServTercPJ" %>
            ...
            <ContentTemplate>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True"
                        AutoGenerateColumns="False" Caption="Lista de Despesas Serviços de Terceiro PJ" CellPadding="4"
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        <tr>
                            <th colspan="1">cadastro de&nbsp; despesas</th>
                            <th colspan="1">
                        ...
                        <tr>
                            ...
                            <td class="direito">
                                <ctx:cTexto runat="server" ID="cTextoAgencia" MaxLength="5" ValidationGroup="pagamentos"></ctx:cTexto>
                                <ctx:cTexto runat="server" ID="cTextoDigitoAgencia" MaxLength="1" Width="15px" ValidationGroup="pagamentos"></ctx:cTexto>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="direito">
                                <ctx:cTexto runat="server" ID="cTextoConta" MaxLength="12" ValidationGroup="pagamentos"></ctx:cTexto>
                                <ctx:cTexto runat="server" ID="cTextoDigitoConta" MaxLength="1" Width="15px" ValidationGroup="pagamentos"></ctx:cTexto>
                            </td>
                        </tr>

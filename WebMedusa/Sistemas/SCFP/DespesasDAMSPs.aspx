<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="DespesasDAMSPs.aspx.cs" Inherits="Medusa.Sistemas.SCFP.DespesasDAMSPs" %>
            ...
            <ContentTemplate>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True"
                        AutoGenerateColumns="False" Caption="Lista de Despesas DAMSP" CellPadding="4"
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        <tr>
                            <th colspan="1">cadastro de&nbsp; despesas DAMSP</th>
                            <th colspan="1">
                        ...
                        <tr>
                            ...
                            <td class="direito">
                                ...
                                <asp:CustomValidator ID="cvBoleto" runat="server" ControlToValidate="txtBoleto" ErrorMessage="inválido" ForeColor="Red" OnServerValidate="cvBoleto_ServerValidate" 
                                    ValidateEmptyText="True" ValidationGroup="boleto"></asp:CustomValidator>
                            </td>
                        </tr>
                        <tr>

<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="DespesasConsumos.aspx.cs" Inherits="Medusa.Sistemas.SCFP.DespesasConsumos" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" Caption="Lista de Despesas Consumos" CellPadding="4" CssClass="tableView" ForeColor="#333333" GridLines="None" OnPageIndexChanging="grid_PageIndexChanging" OnRowCreated="grid_RowCreated" OnRowEditing="grid_RowEditing" OnSorting="grid_Sorting" Width="100%">
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        <tr>
                            <th colspan="1">cadastro de&nbsp; despesas de consumos</th>
                            <th colspan="1">
                        ...
                        <tr>
                            ...
                            <td class="direito">
                                ...
                                <asp:CustomValidator ID="cvBoleto" runat="server" ControlToValidate="txtBoleto"
                                     ErrorMessage="inválido" ForeColor="Red" OnServerValidate="cvBoleto_ServerValidate"
                        ...
                        <tr>
                            <td class="esquerdo">data de vencto:</td>
                            <td class="direito">

...
{
    public partial class DespesaProjetos : PageCrud<DespesaProjetoBLL>
    {
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                LancamentoTipoBLL lt = new LancamentoTipoBLL();
                lt.Get(ObjBLL.ObjEF.id_lancto_tipo);
                lista.DataSource = lt.ObjEF.PlanoContaTipoLanctos.Select(it => it.plconta).DefaultIfEmpty();
        ...
        protected override void Get()
        {
            ...
            this.lista.SelectedValue = Util.InteiroToString(ObjBLL.ObjEF.id_plano_conta);
        ...
        protected override void Set()
        {
            ...
            ObjBLL.ObjEF.id_plano_conta = Convert.ToInt32(this.lista.SelectedValue);
        }

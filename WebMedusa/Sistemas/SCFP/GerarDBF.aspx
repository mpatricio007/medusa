<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="GerarDBF.aspx.cs" Inherits="Medusa.Sistemas.RemessaBancaria.GerarDBF" %>
            ...
            <ContentTemplate>
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        <tr>
                            <th colspan="1">
                                Gerar arquivo dbf para o SCFP</th>
                            <th colspan="1">
                        ...
                        <tr>
                            <th colspan="2">
                            <div id="dGravacao1">
                                <asp:Button ID="btGerar0" runat="server" Text="gerar DBF" OnClientClick="onProcessar();"

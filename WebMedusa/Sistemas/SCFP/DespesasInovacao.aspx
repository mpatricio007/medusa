<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="DespesasInovacao.aspx.cs" Inherits="Medusa.Sistemas.SCFP.DespesasInovacao" %>
            ...
            <ContentTemplate>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True"
                        AutoGenerateColumns="False" Caption="Lista de Despesas Inovação" CellPadding="4"
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        <tr>
                            <th colspan="1">cadastro de&nbsp;despesas inovação</th>
                            <th colspan="1">

<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="DespesasGRFs.aspx.cs" Inherits="Medusa.Sistemas.SCFP.DespesasGRFs" %>
            ...
            <ContentTemplate>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True"
                        AutoGenerateColumns="False" Caption="Lista de Despesas GRF" CellPadding="4"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="projeto" SortExpression="Projeto.codigo.Value">
                                <ItemTemplate>
                            ...
                            <asp:BoundField DataField="dataVencto" DataFormatString="{0:d}" HeaderText="dt. vencto." SortExpression="dataVencto">
                            <HeaderStyle HorizontalAlign="Left" />
                            <ItemStyle HorizontalAlign="Left" />
                            </asp:BoundField>
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        <tr>
                            <th colspan="1">cadastro de&nbsp; despesas GRF</th>
                            <th colspan="1">
                        ...
                        <tr>
                            <td class="esquerdo">código de barras:<asp:Label ID="txtCodigo" runat="server" Text="0" Visible="False"></asp:Label></td>
                            
                            <td class="direito">
                                <%--<cint:cInteiro ID="cIntCodigo" runat="server" ontextchanged="txtInteiro_TextChanged" AutoPostBack="true" />--%>
                                <asp:TextBox ID="txtBoleto" runat="server" AutoPostBack="True" CssClass="boleto" MaxLength="55" OnTextChanged="txtBoleto_TextChanged" Width="500px"></asp:TextBox>
                                <asp:CustomValidator ID="cvBoleto" runat="server" ControlToValidate="txtBoleto" ErrorMessage="inválido" ForeColor="Red" 
                                    OnServerValidate="cvBoleto_ServerValidate" ValidateEmptyText="True" ValidationGroup="boleto"></asp:CustomValidator>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="direito">
                                <ctx:cTexto ID="cTextoRp" runat="server" MaxLength="50" />
                            </td>
                        </tr>
                        <tr>

<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="DespesaProjetos.aspx.cs" Inherits="Medusa.Sistemas.SCFP.DespesaProjetos" %>
            ...
            <ContentTemplate>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True"
                        AutoGenerateColumns="False" Caption="Lista de despesas de Projetos" CellPadding="4"
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        <tr>
                            <th colspan="1">cadastro de&nbsp; despesa projeto</th>
                            <th colspan="1">
                        ...
                        <tr>
                            <td class="esquerdo">projeto:<asp:Label ID="txtCodigo" runat="server" Text="0" Visible="False"></asp:Label>
                            </td>
                            <td class="direito">
                        ...
                        <tr>
                            ...
                            <td class="direito">
                                <ctx:cTexto ID="cTextoDescricao" runat="server" TextMode="MultiLine" Width="500px" Height="200px" />
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">plano de contas:</td>
                            <td class="direito">

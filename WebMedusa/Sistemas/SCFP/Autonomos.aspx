<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="Autonomos.aspx.cs" Inherits="Medusa.Sistemas.SCFP.Autonomos" %>
               ...
               <div class="FilterName">
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Autônomos" CellPadding="4" 
                    ...
                    <table class="cadastro">
                        ...
                        <tr>
                            <td class="esquerdo">
                                dependentes:</td>
                            <td class="direito">
                                <cint:cInteiro ID="cInteiroDependente" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">

<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="ProcessarDespesa.aspx.cs" Inherits="Medusa.Sistemas.SCFP.ProcessarDespesa" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="data_despesa">data </asp:ListItem>
                        <asp:ListItem Value="LancamentoTipo.nome">tipo de despesa</asp:ListItem>
                    </asp:DropDownList>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Processamentos de Despesas" CellPadding="4" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="data_execucao" HeaderText="data de processamento" SortExpression="data_execucao" >
                            ...
                            <asp:TemplateField HeaderText="tipo de lançamento" SortExpression="LanctoTipo.nome">
                              
                                <ItemTemplate>
                                    <asp:Label ID="Label2" runat="server" Text='<%# Bind("LancamentoTipo.nome") %>'></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:TemplateField>
                            <asp:BoundField DataField="data_despesa" HeaderText="data da despesa" 
                                SortExpression="data_despesa" DataFormatString="{0:d}">
                            <HeaderStyle HorizontalAlign="Left" />
                            <ItemStyle HorizontalAlign="Left" />
                            </asp:BoundField>
                    ...
                    <table class="cadastro">
                        ...
                        <tr>
                            <td class="esquerdo">
                                tipo de folha:</td>
                            <td class="direito">
                                <cDdlLancamentoTipo:cDdlLancamentoTipo ID="cDdlLancamentoTipo1" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">

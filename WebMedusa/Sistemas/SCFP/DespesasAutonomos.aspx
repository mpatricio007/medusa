<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="DespesasAutonomos.aspx.cs" Inherits="Medusa.Sistemas.SCFP.DespesasAutonomos" %>
            ...
            <ContentTemplate>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True"
                        AutoGenerateColumns="False" Caption="Lista de Despesas Autônomos" CellPadding="4"
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        <tr>
                            <th colspan="1">cadastro de&nbsp; despesas de autonomos</th>
                            <th colspan="1">
                        ...
                        <tr>
                            <td class="esquerdo" style="height: 28px">iss:</td>
                            <td class="direito" style="height: 28px">
                                <asp:RadioButtonList ID="rbIss" runat="server"
                        ...
                        <tr>
                            <td class="esquerdo" style="height: 34px">dedução inss:</td>
                            <td class="direito" style="height: 34px">
                                <cvl:cValor ID="cValorDeducaoInss" runat="server" />
                            </td>
                        </tr>
                        <tr>

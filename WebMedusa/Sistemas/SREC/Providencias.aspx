<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="Providencias.aspx.cs" Inherits="Medusa.Sistemas.SREC.Providencias" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
<%@ Register src="SetorsCompetentes.ascx" tagname="SetorsCompetentes" tagprefix="uc1" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="id_providencia">código</asp:ListItem>
                        <asp:ListItem Value="nome">nome</asp:ListItem>
                        <asp:ListItem Value="StatusFinal.nome">status final</asp:ListItem>
                    </asp:DropDownList>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Providencias" CellPadding="4" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="id_providencia" HeaderText="código" SortExpression="id_providencia" >
                            ...
                            <asp:TemplateField HeaderText="status final" SortExpression="StatusFinal.nome">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("StatusFinal.nome") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="Label1" runat="server" Text='<%# Bind("StatusFinal.nome") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                    ...
                    <table class="cadastro">
                        ...
                        <tr>
                            <td class="esquerdo">
                                status final:</td>
                            <td class="direito">
                                <cDdlStatusEntrada:cDdlStatusEntrada ID="cDdlStatusEntrada1" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">setores competentes:</td>
                            <td class="direito">
                                <uc1:SetorsCompetentes ID="SetorsCompetentes1" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">

<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="StatusEntradas.aspx.cs" Inherits="Medusa.Sistemas.SREC.StatusEntradas" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
<%@ Register src="../../Controles/ListaPessoaTelefones.ascx" tagname="ListaPessoaTelefones" tagprefix="uc1" %>

<%@ Register src="PossiveisProvidencias.ascx" tagname="PossiveisProvidencias" tagprefix="uc2" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="nome">status</asp:ListItem>
                        <asp:ListItem Value="id_status_entrega">código</asp:ListItem>
                    </asp:DropDownList>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Status de Entrada" CellPadding="4" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="id_status_entrada" HeaderText="código" 
                                SortExpression="id_status_entrada">
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        ...
                        <tr>
                            <td class="esquerdo">escolhe destinatarios:</td>
                            <td class="direito">
                                <asp:CheckBox ID="ckDestinatario" runat="server" CausesValidation="true" />
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">possiveis providencias:</td>
                            <td class="direito">
                                <uc2:PossiveisProvidencias ID="PossiveisProvidencias1" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">

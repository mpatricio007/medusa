<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="Diretoria.aspx.cs" Inherits="Medusa.Sistemas.SREC.Diretoria" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="nprotent">data </asp:ListItem>
                        <asp:ListItem Value="dataprot">protocolo</asp:ListItem>

<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="Bolsas.aspx.cs" Inherits="Medusa.Sistemas.Bolsa.Bolsas" %>
               ...
               <div class="FilterName"> 
                ...
                <asp:Panel ID="panelGrid" runat="server" HorizontalAlign="Left">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Bolsas" 
                        CssClass="tableView" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="num_horas" HeaderText="horas" 
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        ...
                        <tr>
                            ...
                            <td class="direito">
                                <cint:cInteiro ID="cTextoHoras" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">

<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="Cursos.aspx.cs" Inherits="Medusa.Sistemas.Cursos.Cursos" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="id_curso">código</asp:ListItem>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Cursos" CellPadding="4" 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="conta" SortExpression="id_conta">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("id_conta") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="Label1" runat="server" Text='<%# Bind("id_conta") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                    ...
                    <table class="cadastro">
                        ...
                        <tr>
                            <td class="esquerdo">
                                projeto&nbsp;</td>
                            <td class="direito">
                                <ctx:cTexto ID="cTextoProjeto" runat="server" EnableValidator="True" MaxLength="5" 
                                    Width="60" />
                            </td>
                        </tr>
                        <tr>

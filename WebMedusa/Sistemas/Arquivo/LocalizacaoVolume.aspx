<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="LocalizacaoVolume.aspx.cs" Inherits="Medusa.Sistemas.Arquivo.LocalizacaoVolume" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="id_localizacao">código</asp:ListItem>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Localizacao de Volumes" CellPadding="4" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="id_localizacao" HeaderText="código" 
                                SortExpression="id_localizacao">

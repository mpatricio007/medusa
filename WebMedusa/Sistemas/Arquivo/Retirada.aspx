<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="Retirada.aspx.cs" Inherits="Medusa.Sistemas.Arquivo.Retirada" %>
                    ...
                    <table class="cadastro">
                        ...
                        <tr>
                            <td class="esquerdo">
                                retirado por:</td>
                            <td class="direito">
                                <asp:TextBox ID="cTextoUsuRetirada" runat="server" onkeyup="formataInteiro(this,event);" 
                                    ontextchanged="cTextoUsuRetirada_TextChanged" AutoPostBack="True"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="rfvUsuRetirada" runat="server" 
                                    ControlToValidate="cTextoUsuRetirada" ErrorMessage="RequiredFieldValidator"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">

<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="ReportViagemAtraso.aspx.cs" Inherits="Medusa.Sistemas.Adiantamentos.ReportViagemAtraso" %>
                ...
                <asp:Button ID="btGerar" runat="server" onclick="btGerar_Click" 
                    Text="gerar relatório" />
                        ...
                        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
                            ...
                            <LocalReport ReportPath="Relatorios\Adiantamentos\RelatorioDiariasAtraso.rdlc">
                            </LocalReport>
                        </rsweb:ReportViewer>
                 </asp:Panel>

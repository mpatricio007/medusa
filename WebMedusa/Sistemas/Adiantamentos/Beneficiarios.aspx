<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="Beneficiarios.aspx.cs" Inherits="Medusa.Sistemas.Adiantamentos.Beneficiarios" %>
               ...
               <div class="FilterName">
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Beneficiarios" CellPadding="4" 
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="nome" SortExpression="PessoaFisica.nome">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="Label3" runat="server" Text='<%# Bind("PessoaFisica.nome") %>'></asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="cpf" SortExpression="PessoaFisica.cpf.Value">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox2" runat="server" 
                                        Text='<%# Bind("PessoaFisica.cpf") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="Label2" runat="server" Text='<%# Bind("PessoaFisica.cpf") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="unidade" SortExpression="Unidade.nome">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox4" runat="server" Text='<%# Bind("Unidade.nome") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="Label4" runat="server" Text='<%# Bind("Unidade.nome") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                    ...
                    <table class="cadastro">
                        ...
                        <tr>
                            <td class="esquerdo">
                                rg:</td>
                            <td class="direito">
                                <ctx:cTexto ID="cTextoRG" runat="server" EnableValidator="False" 
                                    MaxLength="20" />
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">
                                unidade:</td>
                            <td class="direito">
                                <cDdlUnidades:cDdlUnidades ID="cDdlUnidades1" runat="server" 
                                    ValidationGroup="nao" />
                            </td>
                        </tr>
                        <tr>

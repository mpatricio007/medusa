<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="TiposAdiantamentos.aspx.cs" Inherits="Medusa.Sistemas.Adiantamentos.TiposAdiantamentos" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="codigo_plano_contas">código de plano de contas</asp:ListItem>
                    </asp:DropDownList>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Tipos de Adiantamentos" 
                        CssClass="tableView" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="id_tipo_admto" HeaderText="código" 
                                SortExpression="id_tipo_admto">
                            ...
                            <asp:BoundField DataField="num_dias" HeaderText="números de dias" 
                                SortExpression="num_dias" >
                            <HeaderStyle HorizontalAlign="Left" />
                            </asp:BoundField>
                            <asp:BoundField DataField="codigo_plano_contas" HeaderText="código de plano de contas" 
                                SortExpression="codigo_plano_contas" >
                            <HeaderStyle HorizontalAlign="Left" />
                            <ItemStyle HorizontalAlign="Left" />
                            </asp:BoundField>
                            <asp:BoundField DataField="valor_max" HeaderText="valor máximo" 
                                SortExpression="valor_max">
                            <HeaderStyle HorizontalAlign="Left" />
                            <ItemStyle HorizontalAlign="Left" />
                            </asp:BoundField>
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        <tr>
                            <th colspan="1">
                                cadastro de tipos de adiantamentos</th>
                            <th colspan="1">
                        ...
                        <tr>
                            ...
                            <td class="direito">
                                <table>
                                    <tr>
                                        <td>
                                            <cint:cInteiro ID="cIntNumDias" runat="server" Width="100px" />
                                        </td>
                                        <td>
                                            <asp:RadioButtonList ID="rbTipoDias" runat="server" 
                                                RepeatDirection="Horizontal">
                                                <asp:ListItem Value="False">corridos</asp:ListItem>
                                                <asp:ListItem Value="True">úteis</asp:ListItem>
                                            </asp:RadioButtonList>
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <tr>
                            <td class="esquerdo">
                                código de plano de contas</td>
                            <td class="direito">
                                <cint:cInteiro ID="cIntCodPlano" runat="server" Width="100px" />
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">
                                valor máximo:</td>
                            <td class="direito">
                                <cvl:cValor ID="cIntCValorMax" runat="server" Width="100px" />
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">
                                mensagem:</td>
                            <td class="direito">
                                <ctx:cTexto ID="cTextoMsg" runat="server" EnableValidator="False" 

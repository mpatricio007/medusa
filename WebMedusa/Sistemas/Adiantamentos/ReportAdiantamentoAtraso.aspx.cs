...
{
    public partial class ReportAdiantamentoAtraso : System.Web.UI.Page
    {
        ...
        protected void btGerar_Click(object sender, EventArgs e)
        {
            ...
            ReportDataSource rpd = new ReportDataSource("dsRelatorioEmAtraso", r.GetAdiantamentosEmAtraso(cDdlProjeto.Id_projeto,

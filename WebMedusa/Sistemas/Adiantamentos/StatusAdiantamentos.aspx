<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="StatusAdiantamentos.aspx.cs" Inherits="Medusa.Sistemas.Adiantamentos.StatusAdiantamentos" %>
               ...
               <div class="FilterName">
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Status de Adiantamentos" 
                        CssClass="tableView" 
                        ...
                        <Columns>
                            ...
                            <asp:CheckBoxField DataField="gerar_lancto" HeaderText="gerar lançamento" 
                                SortExpression="gerar_lancto" >
                            <HeaderStyle HorizontalAlign="Left" />
                            <ItemStyle HorizontalAlign="Left" />
                            </asp:CheckBoxField>
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        <tr>
                            <th colspan="1">
                                cadastro de status de adiantamentos</th>
                            <th colspan="1">
                        ...
                        <tr>
                            <td class="esquerdo">
                                visível:</td>
                            <td class="direito">
                                <asp:CheckBox ID="ckVisivel" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">

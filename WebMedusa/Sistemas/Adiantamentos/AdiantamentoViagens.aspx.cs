...
{
    public partial class AdiantamentoViagens : PageCrud<AdiantamentoViagemBLL>
    {
        ...
        protected override void Get()
        {
            ...
            this.cDataRetorno.Value = ObjBLL.ObjEF.data_retorno;
            cDataVencto.Value = ObjBLL.ObjEF.data_vencimento;
            this.cDataPartida.Value = ObjBLL.ObjEF.data_partida;
            this.cValorViagem.Value = ObjBLL.ObjEF.valor;
            ...
            cDataPagamento.Value = ObjBLL.ObjEF.data_pagamento;
            ...
            dPrazo.Visible = btRelatorioViagem.Visible = ObjBLL.Exists();
        }

        protected override void Set()
        {
            ObjBLL.ObjEF.id_adiantamento = Convert.ToInt32(this.txtCodigo.Text);
            ObjBLL.ObjEF.data_partida = this.cDataPartida.Value;
            ObjBLL.ObjEF.data_retorno = cDataRetorno.Value;
            ObjBLL.ObjEF.data_pagamento = cDataPagamento.Value;
            ObjBLL.ObjEF.data = this.cData.Value.GetValueOrDefault();
            ObjBLL.ObjEF.data_vencimento = this.cDataVencto.Value;
            ObjBLL.ObjEF.valor = this.cValorViagem.Value.GetValueOrDefault();
        ...
        protected override void SetAdd()
        {
            ...
            btRelatorioViagem.Visible = false;
        }
        ...
        protected override void SetGrid()
        {
            var f = new Filter()
            {
                ...
                value = Convert.ToString(TiposAdiantamentoBLL.viagem),
                mode = "=="
            };
            filtros.Add(f);
        ...
        protected void btRelatorioViagem_Click(object sender, EventArgs e)
        {
            Util.NovaJanela(String.Format("ReportAdiantamentoViagem.aspx?pk={0}", PkValue.ToString().Criptografar()));
        }
        ...
        {
            ObjBLL.Get(PkValue);
            cDataVencto.Value = cDataPagamento.Value.Value.AddBusinessDays(ObjBLL.ObjEF.TiposAdiantamento.num_dias);
        }

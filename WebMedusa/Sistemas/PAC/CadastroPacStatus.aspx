<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="CadastroPacStatus.aspx.cs" Inherits="Medusa.Sistemas.PAC.CadastroPacStatus" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="id_pac_status">código</asp:ListItem>
                        <asp:ListItem Value="descricao">descrição</asp:ListItem>
                        <asp:ListItem Value="ModalidadeCompra.nome">modalidade compra</asp:ListItem>
                        <asp:ListItem>ordem</asp:ListItem>
                    </asp:DropDownList>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Status de PAC" CellPadding="4" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="id_pac_status" HeaderText="código" 
                                SortExpression="id_pac_status" >
                            ...
                            <asp:TemplateField HeaderText="modalidade compra" 
                                SortExpression="ModalidadeCompra.nome">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox1" runat="server" 
                                        Text='<%# Bind("ModalidadeCompra.nome") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="Label1" runat="server" 
                                        Text='<%# Bind("ModalidadeCompra.nome") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:CheckBoxField DataField="visivel" HeaderText="visivel" 
                                SortExpression="visivel" />
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        ...
                        <tr>
                            ...
                            <td class="direito">
                                <cddlModalidadeCompra:cDdlModalidadeCompra ID="cDdlModalidadeCompra1" 
                                    runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">
                                ordem:</td>
                            <td class="direito">
                                <cint:cInteiro ID="cInteiroOrdem" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">
                        ...
                        <tr>
                            <td class="esquerdo">
                                visivel:</td>
                            <td class="direito">
                                <asp:CheckBox ID="CheckVisivel" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">

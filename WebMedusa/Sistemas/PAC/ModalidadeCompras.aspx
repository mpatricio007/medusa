<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="ModalidadeCompras.aspx.cs" Inherits="Medusa.Sistemas.PAC.ModalidadeCompras" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="id_modalidade_compra">código</asp:ListItem>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Modalidade de Compras" 
                        CssClass="tableView" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="id_modalidade_compra" HeaderText="código" 
                                SortExpression="id_modalidade_compra" >
                            </asp:BoundField>
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        ...
                        <tr>
                            ...
                            <td class="direito">
                                <asp:Label ID="txtCodigo" runat="server">0</asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">
                        ...
                        <tr>
                            ...
                            <td class="direito">
                                <ctx:cTexto ID="cTextoDescricao" runat="server" EnableValidator="False" MaxLength="150" 
                                    Width="300" />
                            </td>
                        </tr>
                        <tr>

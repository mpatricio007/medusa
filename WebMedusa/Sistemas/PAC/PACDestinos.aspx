<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="PACDestinos.aspx.cs" Inherits="Medusa.Sistemas.PAC.PACDestinos" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="id_destino">código</asp:ListItem>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Destinos" 
                        CssClass="tableView" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="id_destino" HeaderText="código" 
                                SortExpression="id_destino" >

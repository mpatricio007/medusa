<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="PesquisaRemessas.aspx.cs" Inherits="Medusa.Sistemas.RemessaBancaria.PesquisaRemessas" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="id_lote">lote</asp:ListItem>
                        <asp:ListItem Value="id_remessa">nº do pagamento</asp:ListItem>
                        <asp:ListItem Value="nome_fav_cedente">beneficiário/cedente</asp:ListItem>
                        <asp:ListItem Value="LoteRemessa.data_pgto">data pagto</asp:ListItem>
                        <asp:ListItem Value="valor">valor</asp:ListItem>
                        <asp:ListItem>status</asp:ListItem>
                        <asp:ListItem Value="LoteRemessa.Conta.numero">conta</asp:ListItem>
                    </asp:DropDownList>
                    <asp:DropDownList ID="listaStatus" runat="server" DataTextField="codigo" DataValueField="id_tipo_ret" AutoPostBack="true" AppendDataBoundItems="True">
                    </asp:DropDownList>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Remessas" CellPadding="4" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="id_remessa" HeaderText="remessa" 
                                SortExpression="id_remessa" >
                            <HeaderStyle HorizontalAlign="Left" />
                            </asp:BoundField>
                            ...
                            <asp:TemplateField HeaderText="data pagto" 
                                SortExpression="LoteRemessa.data_pgto">
                                <ItemTemplate>
                                    <asp:Label ID="Label1" runat="server" 
                                        Text='<%# Bind("LoteRemessa.data_pgto", "{0:d}") %>'></asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="status" SortExpression="TipoRetorno.codigo">
                                <ItemTemplate>

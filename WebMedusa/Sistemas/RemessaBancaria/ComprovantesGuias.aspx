 <%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="ComprovantesGuias.aspx.cs" Inherits="Medusa.Sistemas.RemessaBancaria.ComprovantesGuias" %>
               ...
               <div class="FilterName">
                ...
                <asp:Panel ID="panelGrid" runat="server">
                 ...
                 <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        ...
                        Caption="Lista de Comprovantes de Contas, Tributos e Impostos" CellPadding="4" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="descricao" HeaderText="descrição" 
                               ...
                               <asp:TemplateField HeaderText="linha digitável" SortExpression="codbarra">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox4" runat="server" Text='<%# Bind("Guia") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="Label4" runat="server" Text='<%# Bind("Guia") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                ...
                <div id="dReport" runat="server"></div>
            </ContentTemplate>
        </asp:UpdatePanel>
</div>
</asp:Content>

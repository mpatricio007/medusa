<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="TipoArquivos.aspx.cs" Inherits="Medusa.Sistemas.RemessaBancaria.TipoArquivos" %>
               ...
               <div class="FilterName">
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Tipos de Arquivos" CellPadding="4" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="tipo_segmento" HeaderText="tipo de segmento" 
                                SortExpression="tipo_segmento" />
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        <tr>
                            <th colspan="1">
                                cadastro de tipos de arquivos</th>
                            <th colspan="1">
                        ...
                        <tr>
                            ...
                            <td class="direito">
                                <ctx:cTexto ID="cTextoTipoSegmento" runat="server" EnableValidator="True" 
                                    MaxLength="1" Width="10px" />
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">

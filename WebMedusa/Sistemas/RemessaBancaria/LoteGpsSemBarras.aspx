<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="LoteGpsSemBarras.aspx.cs" Inherits="Medusa.Sistemas.RemessaBancaria.LoteGpsSemBarras" %>
               ...
               <div class="FilterName">
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de GPS sem código de barras" CellPadding="4" 
                    ...
                    <ajaxToolkit:TabContainer ID="tabs" runat="server" ActiveTabIndex="1" AutoPostBack="True" 
                        ...
                        <asp:TabPanel ID="tbCadastro" runat="server" HeaderText="cadastro">
                            <ContentTemplate>
                                <table class="cadastro">
                                    <tr>
                                        <th colspan="1">cadastro de lotes de guias e contas de consumo</th>
                                        <th colspan="1">
                        ...
                        <asp:TabPanel ID="tbPagamentos" runat="server" HeaderText="pagamentos">
                            ...
                            <ContentTemplate>
                                <table class="cadastro">
                                    <tr>
                                        <th colspan="1">cadastro de GPS sem código de barras</th>
                                        <th colspan="1">
                                    ...
                                    <tr>
                                        <td class="esquerdo">lote:<asp:Label ID="txtId_pagamento" runat="server" Text="0" Visible="False"></asp:Label></td>
                                        <td class="direito">
                                    ...
                                    <tr>
                                        ...
                                        <td class="direito">
                                            <ctx:cTexto ID="cTextoCedente" runat="server" Width="500px" ValidationGroup="pagamentos" MaxLength="30" CssClass="txtCedente" />
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="esquerdo">identificador: (CNPJ ou Insc. INSS)</td>
                                        <td class="direito">
                                            <ctx:cTexto ID="cTextoIdentificador" runat="server" MaxLength="14" />
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="esquerdo" style="height: 31px">Código de pagamento:</td>
                                        <td class="direito" style="height: 31px">
                                            <asp:TextBox ID="txtReceita" runat="server" Width="41px">002100</asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="direito">
                                            <cvl:cValor ID="cValor" runat="server" ValidationGroup="pagamentos" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="esquerdo">outras entidades:</td>
                                        <td class="direito">
                                            <cvl:cValor ID="cValorOutrasEnt" runat="server" ValidationGroup="pagamentos" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="esquerdo">atualização monetária:</td>
                                        <td class="direito">
                                            <cvl:cValor ID="cValorAtualMon" runat="server" ValidationGroup="pagamentos" />
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr runat="server" id="trExibeMotivo">
                                        <td class="esquerdo" runat="server">motivo:</td>

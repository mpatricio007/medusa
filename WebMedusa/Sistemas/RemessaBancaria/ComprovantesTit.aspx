<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="ComprovantesTit.aspx.cs" Inherits="Medusa.Sistemas.RemessaBancaria.ComprovantesTit" %>
               ...
               <div class="FilterName">
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Comprovantes de Títulos" CellPadding="4" 

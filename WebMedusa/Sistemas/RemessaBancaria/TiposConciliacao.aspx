<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="TiposConciliacao.aspx.cs" Inherits="Medusa.Sistemas.RemessaBancaria.TiposConciliacao" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="id_tipo_conciliacao">código</asp:ListItem>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Tipos de Conciliacão" CellPadding="4" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="id_tipo_conciliacao" HeaderText="código" 
                                SortExpression="id_tipo_conciliacao" >
                            ...
                            <asp:CheckBoxField DataField="imprime_comprovante" 
                                HeaderText="imprime comprovante" SortExpression="imprime_comprovante">
                            <HeaderStyle HorizontalAlign="Left" />
                            </asp:CheckBoxField>
                            <asp:CheckBoxField DataField="tem_autenticacao" HeaderText="tem autenticação" 
                                SortExpression="tem_autenticacao" />
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        <tr>
                            <th colspan="1">
                                cadastro de tipo de conciliacao</th>
                            <th colspan="1">
                        ...
                        <tr>
                            ...
                            <td class="direito">
                                <asp:CheckBox ID="ckImprimeComp" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">

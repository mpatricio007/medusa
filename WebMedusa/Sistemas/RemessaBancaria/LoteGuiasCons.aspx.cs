...
{
    public partial class LoteGuiasCons : PageCrud<LoteConsBLL>
    {
        ...
        protected void SetPagamento(RemessaCons rem)
        {
            ...
            rem.Guia = new CodigoBarrasConsumo(this.txtBoleto.Text);
        ...
        {
            RemessaConsBLL remBLL = new RemessaConsBLL();

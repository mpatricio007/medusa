...
{
    public partial class ComprovantesTit : PageCrud<RemessaTitBLL>
    {
        ...
        protected void SetReport()
        {
            ...
            ReportViewer1.LocalReport.ReportPath = @"Relatorios\RemessaBancaria\RelatorioComprovantePagtoTit.rdlc";
            var r = new RelatorioRemessaTitulo();
            ReportDataSource rpd = new ReportDataSource("dsComprovanteTit", r.GerarRelatorioComprovantes(ObjBLL.Find(
                filtros,
                (string)ViewState["SortExpression"],
                (string)ViewState["SortDirection"], 0).OfType<RemessaTit>().ToList()));

...
{
    public partial class ComprovantesGru : PageCrud<RemessaGruBLL>
    {
        ...
        protected void SetReport()
        {
            ...
            ReportViewer1.LocalReport.ReportPath = @"Relatorios\RemessaBancaria\RelatorioComprovanteGru.rdlc";
            var r = new RelatorioRemessaGRU();
            ReportDataSource rpd = new ReportDataSource("dsRemessaGru", r.GerarRelatorioComprovantes(ObjBLL.Find(
                filtros,
                (string)ViewState["SortExpression"],
                (string)ViewState["SortDirection"], 0).OfType<RemessaGru>().ToList()));

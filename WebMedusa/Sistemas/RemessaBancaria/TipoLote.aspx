<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="TipoLote.aspx.cs" Inherits="Medusa.Sistemas.Comum.TipoLote" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="id_tipo_lote">id</asp:ListItem>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Tipos de Lotes" CellPadding="4" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="id_tipo_lote" HeaderText="id" 
                                SortExpression="id_tipo_lote" >

<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="LoteGuiasCons.aspx.cs" Inherits="Medusa.Sistemas.RemessaBancaria.LoteGuiasCons" %>
               ...
               <div class="FilterName">
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Lotes de Guias e Contas" CellPadding="4" 
                    ...
                    <ajaxToolkit:TabContainer ID="tabs" runat="server" ActiveTabIndex="1" AutoPostBack="True" 
                        ...
                        <asp:TabPanel ID="tbPagamentos" runat="server" HeaderText="pagamentos">
                            <ContentTemplate>
                                <table class="cadastro">
                                    <tr>
                                        <th colspan="1">cadastro de guias, contas e impostos </th>
                                        <th colspan="1">
                                    ...
                                    <tr>
                                        ...
                                        <td class="direito">
                                            <asp:TextBox ID="txtBoleto" runat="server" CssClass="boleto"
                                                ...
                                                OnTextChanged="txtBoleto_TextChanged"></asp:TextBox><asp:CustomValidator ID="cvBoleto" runat="server" ControlToValidate="txtBoleto"
                                                    ErrorMessage="inválido" OnServerValidate="cvBoleto_ServerValidate"
                                                    ValidateEmptyText="True" ForeColor="Red" Enabled="False"></asp:CustomValidator></td>
                                    </tr>
                                    <tr>

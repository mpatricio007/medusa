...
{
    public partial class LoteGpsSemBarras : PageCrud<LoteGPSBLL>
    {
        ...
        protected void SetPagamento(RemessaGpsSemCodBarra rem)
        {
            ...
            rem.valor_gps = cValor.Value.GetValueOrDefault();
            ...
            rem.cod_receita = this.txtReceita.Text;
            rem.outras_entidades = cValorOutrasEnt.Value.GetValueOrDefault();
            rem.atual_monetaria = cValorAtualMon.Value.GetValueOrDefault();
            rem.valor = rem.valor_gps + rem.outras_entidades + rem.atual_monetaria;
        }

        protected void GetPagamento(int intId_remessa)
        {
            RemessaGpsSemCodBarraBLL remBLL = new RemessaGpsSemCodBarraBLL();
            ...
            this.cTextoCedente.Text = remBLL.ObjEF.nome_fav_cedente;
            this.cValor.Value = remBLL.ObjEF.valor_gps;
            ...
            this.txtReceita.Text = remBLL.ObjEF.cod_receita;
            this.cValorOutrasEnt.Value = remBLL.ObjEF.outras_entidades;
            this.cValorAtualMon.Value = remBLL.ObjEF.atual_monetaria;

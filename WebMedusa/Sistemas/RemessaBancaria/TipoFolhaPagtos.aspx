<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="TipoFolhaPagtos.aspx.cs" Inherits="Medusa.Sistemas.RemessaBancaria.TipoFolhaPagtos" %>
               ...
               <div class="FilterName"> 
                ...
                <asp:Panel ID="panelGrid" runat="server" HorizontalAlign="Left">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Tipos de Folhas de Pagamentos" 
                        CssClass="tableView" 
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    <table class="cadastro">
                        <tr>
                            <th colspan="1">
                                cadastro de tipo de folha de pagamento</th>
                            <th colspan="1">

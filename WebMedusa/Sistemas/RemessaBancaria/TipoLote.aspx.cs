...
{
    public partial class TipoLote : PageCrud<TipoLoteBLL>
    {
        protected override void Page_Load(object sender, EventArgs e)
        {
            // chave primária da tabela
            PRIMARY_KEY = "id_tipo_lote";
        ...
        {
            ObjBLL.Get(PkValue);
            this.txtCodigo.Text = Convert.ToString(ObjBLL.ObjEF.id_tipo_lote);
        ...
        {
            ObjBLL.ObjEF.id_tipo_lote = Convert.ToInt32(this.txtCodigo.Text);

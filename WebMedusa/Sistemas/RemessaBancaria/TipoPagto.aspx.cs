...
{
    public partial class TipoPagto : PageCrud<TipoPagtoBLL>
    {
        protected override void Page_Load(object sender, EventArgs e)
        {
            // chave primária da tabela
            PRIMARY_KEY = "id_tipo_pagto";
        ...
        {
            ObjBLL.Get(PkValue);
            this.txtCodigo.Text = Convert.ToString(ObjBLL.ObjEF.id_tipo_pagto);
        ...
        {
            ObjBLL.ObjEF.id_tipo_pagto = Convert.ToInt32(this.txtCodigo.Text);

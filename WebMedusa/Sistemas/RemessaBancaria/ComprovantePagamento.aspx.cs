...
{
    public partial class ComprovantePagamento : PageCrud<RemessaPAGBLL>
    {
        ...
        protected void SetReport()
        {
            ...
            ReportViewer1.LocalReport.ReportPath = @"Relatorios\RemessaBancaria\RelatorioComprovantePagto.rdlc";

            var r = new RelatorioRemessaPAG();
            ReportDataSource rpd = new ReportDataSource("dsComprovantePagto", r.GerarRelatorioComprovantes(ObjBLL.Find(
                filtros,
                (string)ViewState["SortExpression"],
                (string)ViewState["SortDirection"], 0).OfType<RemessaPAG>().ToList()));

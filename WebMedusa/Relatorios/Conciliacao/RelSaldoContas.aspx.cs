...
{
    public partial class RelSaldoContas : BasePage
    {
        ...
        protected void GerarRelatorio()
        {
            ...
            ReportViewer1.LocalReport.ReportPath = @"Relatorios\Conciliacao\RelSaldoContas.rdlc";
            ...
            var r = new RelatorioSaldoContas();

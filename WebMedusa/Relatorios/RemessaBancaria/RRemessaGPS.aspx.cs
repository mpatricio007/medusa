...
{
    public partial class RRemessaGPS : BasePage
    {
        protected void btGerarRelatorio_Click(object sender, EventArgs e)
        {
            Cache.Remove("lotes");
            dRelatorio.InnerHtml = String.Format("<iframe src=\"../../Relatorios/RemessaBancaria/ReportRemessaGPS.aspx?pk1={0}&pk2={1}&pk3={2}\" width=\"100%\" height=\"1000px\"></iframe>",
        ...
        protected void btGerarArquivo_Click(object sender, EventArgs e)
        {
            ...
            tbReenvio.Visible = ((List<LoteGPS>)Cache["lotes"]).Count() > 0;
        ...
        public void SetGridLotesEnviados()
        {
            ...
            gridLotesEnviados.DataSource = (List<LoteGPS>)Cache["lotes"];
        ...
        protected void btOk_Click(object sender, EventArgs e)
        {
            ...
            {
                foreach (var item in (List<LoteGPS>)Cache["lotes"])
                {
                    var lBLL = new LoteGPSBLL();

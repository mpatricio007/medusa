<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="RRemessaPAG.aspx.cs" Inherits="Medusa.Relatorios.RemessaBancaria.RRemessaPAG" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    ...
                    <tr>
              <th colspan="1">
                  relatório de remessas de pagamentos</th>
              <th colspan="1">
              </th>
        </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div id="dGravacao" runat="server">
                                                &nbsp;<asp:Button ID="btGerarArquivo" runat="server" OnClick="btGerarArquivo_Click"
                                                    OnClientClick="onProcessar();" Text="gerar arquivos" />
                                            </div>
                                        </td>
                                    </tr>
                                </table>

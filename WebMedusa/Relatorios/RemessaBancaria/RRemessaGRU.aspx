<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="RRemessaGRU.aspx.cs" Inherits="Medusa.Relatorios.RemessaBancaria.RRemessaGRU" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <asp:Panel ID="panelCadastro" runat="server">
                    ...
                    <tr>
              <th colspan="1">
                  relatório de remessas de gru</th>
              <th colspan="1">
              </th>
        </tr>
         ...
         <tr>
             <th colspan="2">
                  <table class="tabcadastro">
                                    <tr>
                                        <td >
                                            <asp:Button ID="btGerarRelatorio" runat="server" OnClick="btGerarRelatorio_Click"

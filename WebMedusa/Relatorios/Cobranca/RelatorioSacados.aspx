<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.master" AutoEventWireup="true" CodeBehind="RelatorioSacados.aspx.cs" Inherits="Medusa.Relatorios.Cobranca.RelatorioSacados" %>
        ...
        <ContentTemplate>
            ...
            <table class="cadastro">
                ...
                <tr>
                    ...
                    <td class="direito">
                        <cDdlEventos:cDdlEventos ID="cDdlEventos1" runat="server" />
                    </td>
                </tr>
                <tr>
                    <th colspan="2">

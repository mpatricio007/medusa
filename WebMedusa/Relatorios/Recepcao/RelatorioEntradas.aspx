<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.master" AutoEventWireup="true" CodeBehind="RelatorioEntradas.aspx.cs" Inherits="Medusa.Relatorios.Recepcao.RelatorioEntradas" %>
        ...
        <tr>
            <th colspan="2">
                ...
                <%--<rsweb:ReportViewer ID="ReportViewer1" runat="server" 
                    CssClass="aspNetDisabled aspNetDisabled aspNetDisabled aspNetDisabled aspNetDisabled aspNetDisabled aspNetDisabled aspNetDisabled aspNetDisabled aspNetDisabled aspNetDisabled aspNetDisabled" 
                    Enabled="False" Font-Names="Verdana" Font-Size="8pt" 
                    InteractiveDeviceInfos="(Collection)" WaitMessageFont-Names="Verdana" 
                    WaitMessageFont-Size="14pt" Width="100%">
                    <LocalReport ReportPath="Relatorios\Recepcao\RelatorioEntrada.rdlc">
                    </LocalReport>
                </rsweb:ReportViewer>--%>
            </ContentTemplate>
            </asp:UpdatePanel>

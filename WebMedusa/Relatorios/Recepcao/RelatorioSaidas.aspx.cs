...
{
    public partial class RelatorioSaidas : BasePage
    {
        ...
        {
            Util.NovaJanela(String.Format("ReportSaida.aspx?pk1={0}&pk2={1}&pk3={2}", Convert.ToString(cInteiroDe.Value.GetValueOrDefault()).Criptografar(),

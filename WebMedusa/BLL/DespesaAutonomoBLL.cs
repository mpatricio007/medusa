...
{
    public class DespesaAutonomoBLL : DespesaPessoaFisicaBLL<DespesaAutonomo>//DespesaBLL<DespesaAutonomo>
    {
        public override bool temIss
        {
            get
            {
                return ObjEF.iss;
        ...
        public DespesaAutonomoBLL()
        {

        }

        public DespesaAutonomoBLL(Contexto _dbContext)
        {
        ...
        {            
            ...
            foreach (var pc in tipoLancto)
            {
                ...
                if (CalcularEsteCodigoPC(pc.plconta.codigo))
                {
                    ...
                    if (pc.plconta.Taxa != null)
                    {
                        ...
                        if (pc.plconta.codigo.Equals(Constantes.INSS))
                        {
                            txBLL.inss_outr_empresa = ObjEF.deducaoINSS;
                            txBLL.valorAdeduzir += GetTotalMesOutrInss();
                        }
        ...
        public decimal GetTotalMesOutrInss()
        {
            return GetListPagtosDoMes().Sum(it => it.deducaoINSS);
        }

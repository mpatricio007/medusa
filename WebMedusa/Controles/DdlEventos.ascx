<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DdlEventos.ascx.cs" Inherits="Medusa.Controles.DdlEventos" %>
                <%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
                <asp:DropDownList ID="lista" runat="server" DataTextField="nome" 
                    DataValueField="id_evento" AppendDataBoundItems="True" 
    Width="500px">
                </asp:DropDownList>
...
<asp:CompareValidator ID="cv" runat="server" 
    ErrorMessage="selecione um evento..." ForeColor="Red" Operator="NotEqual" 

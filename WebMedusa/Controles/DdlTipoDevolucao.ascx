<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DdlTipoDevolucao.ascx.cs" Inherits="Medusa.Controles.DdlTipoDevolucao" %>
                <%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
                <asp:DropDownList ID="lista" runat="server" DataTextField="nome" 
                    DataValueField="id_tipo_devolucao" AppendDataBoundItems="True">
                </asp:DropDownList>
...
<asp:CompareValidator ID="cv" runat="server" 
    ErrorMessage="selecione um tipo de devolução..." ForeColor="Red" Operator="NotEqual" 

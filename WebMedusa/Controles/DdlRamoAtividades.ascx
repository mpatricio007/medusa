<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DdlRamoAtividades.ascx.cs" Inherits="Medusa.Controles.DdlRamoAtividades" %>
                <%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
                <asp:DropDownList ID="lista" runat="server" DataTextField="strRamoAtividade" 
                    DataValueField="id_ramo_atividade" AppendDataBoundItems="True">
                </asp:DropDownList>

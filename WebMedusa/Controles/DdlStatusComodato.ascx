<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DdlStatusComodato.ascx.cs" Inherits="Medusa.Controles.DdlStatusComodato" %>
                <%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
                <asp:DropDownList ID="lista" runat="server" DataTextField="nome" 
                    DataValueField="id_status_comodato" 

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DdlStatusRequisicaoMaterial.ascx.cs" Inherits="Medusa.Controles.DdlStatusRequisicaoMaterial" %>
                <%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
                <asp:DropDownList ID="lista" runat="server" DataTextField="nome" 
                    DataValueField="id_status_requisicao_material" AppendDataBoundItems="True">
                </asp:DropDownList>

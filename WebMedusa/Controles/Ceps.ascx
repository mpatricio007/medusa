<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Ceps.ascx.cs" Inherits="Medusa.Controles.Ceps" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="id_cep">código</asp:ListItem>
                        <asp:ListItem Value="uf">uf</asp:ListItem>
                        <asp:ListItem Value="cidade">cidade</asp:ListItem>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        AutoGenerateColumns="False" Caption="Lista de Ceps" CellPadding="4" 
                        ...
                        onsorting="grid_Sorting" Width="100%">
                        <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                        <Columns>
                            <asp:BoundField DataField="id_cep" HeaderText="código" 
                                SortExpression="id_cep">
        ...
        <ajaxToolkit:UpdatePanelAnimationExtender ID="upae" BehaviorID="animation" runat="server" TargetControlID="upCep" Enabled="True">
        <Animations>
            <OnUpdating>
                <Parallel duration="0">

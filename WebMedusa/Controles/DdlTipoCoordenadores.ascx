<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DdlTipoCoordenadores.ascx.cs" Inherits="Medusa.Controles.DdlTipoCoordenadores" %>
...
<asp:CompareValidator ID="cv" runat="server" 
    ErrorMessage="selecione um tipo..." ForeColor="Red" Operator="NotEqual" 

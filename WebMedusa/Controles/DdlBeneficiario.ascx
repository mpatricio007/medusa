<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DdlBeneficiario.ascx.cs" Inherits="Medusa.Controles.DdlBeneficiario" %>
                <%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
                <asp:DropDownList ID="lista" runat="server" DataTextField="nome" 
                    DataValueField="id_beneficiario" 
...
<asp:CompareValidator ID="cv" runat="server" 
    ErrorMessage="selecione um beneficiário..." ForeColor="Red" Operator="NotEqual" 

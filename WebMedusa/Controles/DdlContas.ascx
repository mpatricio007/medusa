<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DdlContas.ascx.cs" Inherits="Medusa.Controles.DdlContas" %>
                <%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>

 
  <asp:DropDownList ID="lista" runat="server" DataValueField="Id_conta" DataTextField="StrBancoAgenciaConta"

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DdlAno.ascx.cs" Inherits="Medusa.Controles.DdlAno" %>
...
<asp:CompareValidator ID="cv" runat="server" 
    ErrorMessage="selecione um ano..." ForeColor="Red" Operator="NotEqual" 

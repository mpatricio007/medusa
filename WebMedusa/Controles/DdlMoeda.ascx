<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DdlMoeda.ascx.cs" Inherits="Medusa.Controles.DdlMoeda" %>
                <%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
                <asp:DropDownList ID="lista" runat="server" DataTextField="nome" 
                    DataValueField="id_moeda" AppendDataBoundItems="True">
                </asp:DropDownList>
...
<asp:CompareValidator ID="cv" runat="server" 
    ErrorMessage="selecione uma moeda..." ForeColor="Red" Operator="NotEqual" 

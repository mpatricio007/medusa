<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DdlProvidencia.ascx.cs" Inherits="Medusa.Controles.DdlProvidencia" %>
                <%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
                <asp:DropDownList ID="lista" runat="server" DataTextField="nome" 
                    DataValueField="id_providencia" AppendDataBoundItems="True" 

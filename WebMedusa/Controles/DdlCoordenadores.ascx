<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DdlCoordenadores.ascx.cs" Inherits="Medusa.Controles.DdlCoordenadores" %>
  <%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
                
           
                <div>
                <asp:DropDownList ID="lista" runat="server" DataTextField="nome" 
                    DataValueField="id_coordenador" AppendDataBoundItems="True">
                </asp:DropDownList>
...
<asp:CompareValidator ID="cv" runat="server" 
    ErrorMessage="selecione um coordenador..." ForeColor="Red" Operator="NotEqual" 

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DdlTipoContratos.ascx.cs" Inherits="Medusa.Controles.DdlTipoContratos" %>
...
<asp:CompareValidator ID="cv" runat="server" 
    ErrorMessage="selecione um tipo de contrato..." ForeColor="Red" Operator="NotEqual" 

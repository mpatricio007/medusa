<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DdlProjeto.ascx.cs" Inherits="Medusa.Controles.DdlProjeto" %>
                <%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
                <asp:DropDownList ID="lista" runat="server" DataTextField="codigo" 
                    DataValueField="id_projeto" AppendDataBoundItems="True" 
...
<asp:CompareValidator ID="cv" runat="server" 
    ErrorMessage="selecione um projeto..." ForeColor="Red" Operator="NotEqual" 

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DdlTipoMateriais.ascx.cs" Inherits="Medusa.Controles.DdlTipoMateriais" %>
                <%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
                <asp:DropDownList ID="lista" runat="server" DataTextField="nome" 
                    DataValueField="id_tipo_material" 
...
<asp:CompareValidator ID="cv" runat="server" 
    ErrorMessage="selecione um tipo de material..." ForeColor="Red" Operator="NotEqual" 

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DdlNaturezaProjeto.ascx.cs" Inherits="Medusa.Controles.DdlNaturezaProjeto" %>
                <%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
                <asp:DropDownList ID="lista" runat="server" DataTextField="nome" 
                    DataValueField="id_nat_projeto" AppendDataBoundItems="True" 
...
<asp:CompareValidator ID="cv" runat="server" 
    ErrorMessage="selecione uma natureza..." ForeColor="Red" Operator="NotEqual" 

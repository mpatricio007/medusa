<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DdlTiposAdiantamentos.ascx.cs" Inherits="Medusa.Controles.DdlTiposAdiantamentos" %>
                <%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
                <asp:DropDownList ID="lista" runat="server" DataTextField="nome" 
                    DataValueField="id_tipo_admto" AppendDataBoundItems="True">
                </asp:DropDownList>
...
<asp:CompareValidator ID="cv" runat="server" 
    ErrorMessage="selecione um tipo de adiantamento..." ForeColor="Red" Operator="NotEqual" 

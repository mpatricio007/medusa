<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DdlLancamentoTipo.ascx.cs" Inherits="Medusa.Controles.DdlLancamentoTipo" %>
                <%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
                <asp:DropDownList ID="lista" runat="server" DataTextField="nome" 
                    DataValueField="id_lancto_tipo" AppendDataBoundItems="True" 

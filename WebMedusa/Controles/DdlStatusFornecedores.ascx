<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DdlStatusFornecedores.ascx.cs" Inherits="Medusa.Controles.DdlStatusFornecedores" %>
                <%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
                <asp:DropDownList ID="lista" runat="server" DataTextField="nome" 
                    DataValueField="id_status_fornecedor" AppendDataBoundItems="True">
                </asp:DropDownList>

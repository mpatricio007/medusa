<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PesquisaOrigemEmail.ascx.cs"
    Inherits="Medusa.Controles.Pesquisa.PesquisaOrigemEmail" %>
<asp:Panel ID="panEdit" runat="server" >
    ...
    <div class="pesquisar">
        ...
        &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlOptions_SelectedIndexChanged">
            ...
            <asp:ListItem Value="tipo" Selected="True">grupo</asp:ListItem>
    ...
    <asp:Panel ID="panelGrid" runat="server">
        <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
            Caption="e-mails" CellPadding="4" CssClass="tableView" ForeColor="#333333" GridLines="None"
            OnPageIndexChanging="grid_PageIndexChanging" OnSorting="grid_Sorting" 
            Width="100%" onrowediting="grid_RowEditing">
            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
            <Columns>
                <asp:BoundField HeaderText="grupo" DataField="tipo" />

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DdlStatusEntrada.ascx.cs" Inherits="Medusa.Controles.DdlStatusEntrada" %>
                <%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
                <asp:DropDownList ID="lista" runat="server" DataTextField="nome" 
                    DataValueField="id_status_entrada" AppendDataBoundItems="True">
                </asp:DropDownList>

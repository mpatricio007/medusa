<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DdlClassificacaoFusp.ascx.cs" Inherits="Medusa.Controles.DdlClassificacaoFusp" %>
                <%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
                <asp:DropDownList ID="lista" runat="server" DataTextField="nome" 
                    DataValueField="id_classificacao_fusp" 
...
<asp:CompareValidator ID="cv" runat="server" 
    ErrorMessage="selecione uma classivicação..." ForeColor="Red" Operator="NotEqual" 

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DdlFinalidadePagto.ascx.cs" Inherits="Medusa.Controles.DdlFinalidadePagto" %>
                <%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
                <asp:DropDownList ID="lista" runat="server" DataTextField="nome" 
                    DataValueField="id_fin_pagto" AppendDataBoundItems="True">
                </asp:DropDownList>

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DdlBolsas.ascx.cs" Inherits="Medusa.Controles.DdlBolsas" %>
                <%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
                <asp:DropDownList ID="lista" runat="server" DataTextField="nome" 
                    DataValueField="id_bolsa" AppendDataBoundItems="True">
                </asp:DropDownList>
...
<asp:CompareValidator ID="cv" runat="server" 
    ErrorMessage="selecione uma bolsa..." ForeColor="Red" Operator="NotEqual" 

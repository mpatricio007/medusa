<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DdlMes.ascx.cs" Inherits="Medusa.Controles.DdlMes" %>
...
<asp:CompareValidator ID="cv" runat="server" 
    ErrorMessage="selecione um mês..." ForeColor="Red" Operator="NotEqual" 

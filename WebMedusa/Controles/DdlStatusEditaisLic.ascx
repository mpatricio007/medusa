<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DdlStatusEditaisLic.ascx.cs" Inherits="Medusa.Controles.DdlStatusEditaisLic" %>
                <%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
                <asp:DropDownList ID="lista" runat="server" DataTextField="nome" 
                    DataValueField="id_status_edital_lic"

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DdlModalidadeCompra.ascx.cs" Inherits="Medusa.Controles.DdlModalidadeCompra" %>
                <%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
                <asp:DropDownList ID="lista" runat="server" DataTextField="nome" 
                    DataValueField="id_modalidade_compra" 
...
<asp:CompareValidator ID="cv" runat="server" 
    ErrorMessage="selecione uma modalidade de compra..." ForeColor="Red" Operator="NotEqual" 

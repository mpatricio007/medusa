<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DdlTipoVolume.ascx.cs" Inherits="Medusa.Controles.DdlTipoVolume" %>
                <%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
                <asp:DropDownList ID="lista" runat="server" DataTextField="nome" 
                    DataValueField="id_tipo" AppendDataBoundItems="True">
                </asp:DropDownList>
...
<asp:CompareValidator ID="cv" runat="server" 
    ErrorMessage="selecione um tipo de volume..." ForeColor="Red" Operator="NotEqual" 

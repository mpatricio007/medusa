<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DdlNatureza.ascx.cs" Inherits="Medusa.Controles.DdlNatureza" %>
                <%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
                <asp:DropDownList ID="lista" runat="server" DataTextField="nome" 
                    DataValueField="id_natureza" AppendDataBoundItems="True" 

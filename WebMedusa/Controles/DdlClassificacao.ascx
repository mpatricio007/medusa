<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DdlClassificacao.ascx.cs" Inherits="Medusa.Controles.DdlClassificacao" %>
                <%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
                <asp:DropDownList ID="lista" runat="server" DataTextField="nome" 
                    DataValueField="id_classificacao" AppendDataBoundItems="True">
                </asp:DropDownList>
...
<asp:CompareValidator ID="cv" runat="server" 
    ErrorMessage="selecione uma classificação..." ForeColor="Red" Operator="NotEqual" 

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DdlAtuacao.ascx.cs" Inherits="Medusa.Controles.DdlAtuacao" %>
                <%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
                <asp:DropDownList ID="lista" runat="server" DataTextField="nome" 
                    DataValueField="id_atuacao" AppendDataBoundItems="True">
                </asp:DropDownList>
...
<asp:CompareValidator ID="cv" runat="server" 
    ErrorMessage="selecione uma atuação..." ForeColor="Red" Operator="NotEqual" 

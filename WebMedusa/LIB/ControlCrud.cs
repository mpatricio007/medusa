...
{
    public abstract class ControlCrud<T> : BaseControl  where T : IBaseCrud, new()
    {
        ...
        private bool? enableGravacao;

        public bool? EnableGravacao
        {
            get 
            {
                if (!enableGravacao.HasValue)
                    enableGravacao = true;
                return enableGravacao; 
            }
            set { enableGravacao = value; }
        }
        ...
        public override void DataBind()
        {
            ...
            while (true)
            {
                ...
                if (div != null)
                {
                    div.Visible = EnableGravacao.GetValueOrDefault();
                    i += 1;
                }
                else
                    break;        
